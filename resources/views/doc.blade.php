                            ...
                            <div class="file-box">
                                ...
                                <div class="row">
                                    ...
                                    @endif
                                        <div class="col-md-7">
                                        @if($value->link  != null)
                                        <div class="col-md-4"><h6><a href="{{URL($value->link)}}"><img src="{{URL('/images/lexuz.png')}}" alt="" width="42" height="15"> Lex.uz да ўқиш</a></h6></div>
                                        @endif
                                            @if($value->other_link  != null)
                                                <div class="col-md-4"><h6><a href="{{URL($value->other_link)}}"><img src="{{URL('/images/icons8-internet-explorer-15.png')}}" alt="" width="15" height="15"> Сайтда ўқиш</a></h6></div>
                                            @endif
                                        @if($value->file_type == 'docx' ||  $value->file_type == 'doc')
                                        <div class="col-md-4"><h6><a href="{{URL(App::getLocale().'/downloads?type=doc&id='.$value->id)}}"><img src="{{URL('/images/msword.jpg')}}" alt="" width="15" height="15"> @lang('blog.download') ({{round($value->file_size/1024)}} KB)</a></h6></div>
                                        @elseif($value->file_type == 'pdf')
                                            <div class="col-md-4"><h6><a href="{{URL(App::getLocale().'/downloads?type=doc&id='.$value->id)}}"><img src="{{URL('/images/pdf_image.jpg')}}" alt="" width="15" height="15"> @lang('blog.download') ({{round($value->file_size/1024)}} KB)</a></h6></div>
                                        @endif
