            ...
            <div class="row">
                @section('nowosti')
                    ...
                    <div class="page-header row">
                        <div class="col-md-9">
                            <h4><b>@lang('blog.resume_pagetitle')</b></h4>
                        </div>
                        <div class="col-md-3 hidden-xs hidden-sm" style="padding-top: 11px;">
                            <a class="page-print-link pull-right" style="cursor:pointer;" target="_self" ><span class="glyphicon glyphicon-print"></span> @lang('blog.print_button')</a>
                        </div>
                    </div>
                        ...
                        <div class="text-left">
                            ...
                            @endif
                                @if(session()->has('message'))
                                    <div class="alert alert-success">
                                        <p>Мурожаатингиз қабул қилинди. Аризангизни руйхат рақами: <span> {{ session()->get('message') }}</span></p>
                                    </div>
                                @endif
                            <form action="{{URL('/cv_form_post')}}" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('phone') }}" name="phone" title="" placeholder="@lang('blog.phone_number_placeholder')" class="form-control" id="">
                                </div>
                                <div class="form-group">
                                    <label for="">@lang('blog.additional_message') <span class="required">*</span>:</label>
                                    <textarea resize="no" name="comment" cols="25" rows="5" title="" placeholder="@lang('blog.additional_message_placeholder')" class="form-control textarea" id="">{{ old('comment') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="">@lang('blog.file_attachment')</label>
