                        ...
                        @if($key == 0)
                            <div class="tab-pane active" id="{{$languages[$key]->id}}">
                                <div class="form" role="form">
                                    ...
                                    <input type="hidden" name="language_id[]" value="{{$languages[$key]->id}}">
                                    <input type="hidden" name="page_id[]" value="{{$pages[$key]->id}}">
                                    <div class="form-group floating-label">
                                        <input type="text" name="title[]" value="{{$pages[$key]->title}}" class="form-control" id="regular2">
                                        <label for="regular2">Title</label>
                                    </div>
                                    <div class="form-group floating-label">
                                        <input type="text" name="description[]" value="{{$pages[$key]->description}}"  class="form-control" id="regular2">
