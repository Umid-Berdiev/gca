...
@section("content")
    ...
    <div class="card-body" style="background-color: white">
        ...
        <div class="col-md-12">
            ...
            <form class="form" role="form" enctype="multipart/form-data" method="post" action="{{  URL("/admin/links/categories/update")}}">
                            ...
                            <div class="tab-pane active" id="{{$language->id}}">
                                <div class="form" role="form">
                                    ...
                                    <div class="form-group floating-label">
                                        <input type="text" name="category_name[]" value="{{$val->title}}"  class="form-control" id="regular2">
