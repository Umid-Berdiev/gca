    ...
    <div class="col-md-12" style="background-color: white;padding: 25px;">
        <div class="col-md-12">
            <div class="form-group">
                <p><button type="button" class="btn ink-reaction btn-floating-action btn-lg btn-primary" onclick="window.location.href='{{ URL("/admin/sorov/create") }}'"><i class="fa fa-plus"></i></button></p>
                ...
                @foreach($table as $key => $page)
                    <tr>
                        ...
                        <td>
                            ...
                            <span><a onclick="return confirm('Are you sure you want to delete this thing into the database?')" href="{{URL('/admin/sorov/delete?id='.$page->group)}}"><i class="fa fa-remove"></i></a></span>
