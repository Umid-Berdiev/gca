...
{{--                            <span><a onclick="return confirm('Are you sure you want to delete this thing into the database?')" href="{{URL('/admin/pages/delete/'.$item->page_group_id)}}"><i class="fa fa-remove"></i></a></span>--}}
