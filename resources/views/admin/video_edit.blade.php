...
@section("content")
    ...
    <div class="card-body" style="background-color: white">
        <div class="col-md-12">
            ...
            <form class="form" role="form" enctype="multipart/form-data" method="post" action="{{  URL("/admin/video/edit")}}">
                                ...
                                @if($val->language_id ==$language->id)
                                    <div class="tab-pane active" id="{{$language->id}}">
                                        <div class="form" role="form">
                                            ...
                                            <div class="form-group floating-label">
                                                <input type="text" name="name[]" class="form-control" value="{{ $val->name }}" id="regular2">
