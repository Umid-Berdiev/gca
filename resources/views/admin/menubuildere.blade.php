        ...
        <div class="col-md-6">
            ...
            <div class="card-body" style="background-color: white">
                <div class="col-md-12">
                    ...
                    <form class="form" role="form" enctype="multipart/form-data" method="post" action="{{  URL("/admin/menubuilder/edit")}}">
                                    ...
                                    <div class="tab-pane active" id="{{$language->id}}">
                                        <div class="form" role="form">
                                            ...
                                            <div class="form-group floating-label">
                                                <input type="text" name="menu_name[]" value="{{ $valuesx->menu_name }}" class="form-control" id="regular2">
                                                                ...
                                                                <ul>
                                                                    @foreach($modelsx as $keytwo=>$valuex)
                                                                        ...
                                                                        @if(count($modelsxs) >0)
                                                                                ...
                                                                                <option value="{{ $valuex->group }}" selected>{{ ($keyone+1).".".($keytwo+1) }})  {{ $valuex->menu_name }}</option>
                                                                                    @else
                                                                                ...
                                                                                @endif
                                                                                    ...
                                                                                    @else
                                                                                            <option value="{{ $valuexx->group }}" selected>{{ ($keyone+1).".".($keytwo+1).".".($keythree+1) }})   {{ $valuexx->menu_name }}</option>
