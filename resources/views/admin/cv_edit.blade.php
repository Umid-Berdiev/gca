            ...
            <form class="form" role="form" enctype="multipart/form-data" method="post" action="{{  URL("/admin/cv_update")}}">
                ...
                <div class="card-body tab-content">
                                            <div class="form-group floating-label">
                                                <input type="text" name="unique_number" disabled class="form-control" value="{{$cv->unique_number}}" id="regular2">
                                            ...
                                            <div class="form-group floating-label">
                                                <input type="text" name="phone_number" disabled class="form-control" value="{{$cv->phone_number}}" id="regular2">
                    ...
                    <div class="form-group">
                        ...
                        <label for="select1">Categories</label>
                                        ...
                                        <div class="form-group floating-label">
                                            <textarea  name="comment" disabled class="form-control" value="{{$cv->phone_number}}" id="regular2">{{$cv->comment}}</textarea>
                                        </div>
                    <div class="form-group floating-label">
