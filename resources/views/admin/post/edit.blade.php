...
<div class="card-body" style="background-color: white">
  <div class="col-md-12">
    ...
    <form class="form" role="form" enctype="multipart/form-data" method="post" action="{{  URL("/admin/post/edit")}}">
          ...
          <div class="form" role="form">
            ...
            <div class="form-group floating-label">
              <input type="datetime-local" name="datetime"
                value="{{\Carbon\Carbon::parse($val->datetime)->format('Y-m-d\TH:i')}}" class="form-control"
                id="regular2">
            </div>
            <div class="form-group floating-label">
            ...
            <div class="form-group floating-label">
              <input type="text" name="decription[]" class="form-control" value="{{ $val->decription }}" id="regular2">
              <label for="regular2">Decription</label>
            </div>

            <div class="form-group floating-label">
              <div><img width="100" src="{{URL(App::getLocale().'/downloads?type=post&id='.$val->group) }}">
              </div>
