                ...
                <nav>
                    <ul class="nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" aria-expanded="false" data-toggle="dropdown" href="#">{{ trans("home.books") }} <i class="fa fa-arrow-down"></i>
                            </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" aria-expanded="false" data-toggle="dropdown" href="#">{{ trans("home.audiobook") }} <i class="fa fa-arrow-down"></i>
                            </a>
                            <ul class="dropdown-menu">
                                <li>
                        ...
                        @endif
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" aria-expanded="false" data-toggle="dropdown" href="#">{{ App::getLocale() }} <i class="fa fa-arrow-down"></i>
                            </a>
