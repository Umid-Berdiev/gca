                    ...
                    @foreach($users as $key=>$user)
                        <tr>
                            ...
                            <td>
                                ...
                                <span onclick="return confirm('Are you sure you want to delete this thing into the database?')"><a href="{{URL('/admin/users/delete?id='.$user->id)}}"><i class="fa fa-remove"></i></a></span>
