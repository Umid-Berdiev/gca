...
savol:{{ $savol->savol }}
                ...
                @foreach($table as $key => $page)
                    <tr>
                        ...
                        <td>
                            ...
                            <span><a onclick="confirm('are you sure delete?')" href="{{URL('/admin/sorovatter/delete?id='.$page->group)}}"><i class="fa fa-remove"></i></a></span>
    ...
    <div class="container" >
        ...
        <div class="col-md-12">
            ...
            <form class="form" role="form" enctype="multipart/form-data" method="post" action="{{  URL("/admin/sorovatter/insert")}}">
