...
@section("content")
    ...
    <div class="card-body" style="background-color: white">
        ...
        <div class="col-md-12">
            ...
            <form class="form" role="form" enctype="multipart/form-data" method="post" action="{{  URL("/admin/raxbariyat/update")}}">
                <div class="card-body tab-content">
                        ...
                        @if($key == 0)
                            <div class="tab-pane active" id="{{$language->id}}">
                                <div class="form" role="form">
                                    ...
                                    <div class="form-group floating-label">
                                        <input type="text" name="major[]" value="{{ $raxbariyat[$key]->major }}" class="form-control" id="regular2">
                                        <label for="regular2">major</label>
                                    </div>

                                    <div class="form-group floating-label">
                                        <input type="text" name="qabul[]" value="{{ $raxbariyat[$key]->qabul }}" class="form-control" id="regular2">
                    ...
                    <div class="form-group floating-label">
                        <div><img width="100" src="{{URL(App::getLocale().'/downloads?type=raxbariyat&id='.$raxbariyat[0]->id) }}"></div>
