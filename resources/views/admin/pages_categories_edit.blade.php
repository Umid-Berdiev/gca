                        ...
                        @if($key == 0)
                            <div class="tab-pane active" id="{{$page_category->language_id}}">
                                <div class="form" role="form">
                                    ...
                                    <input type="hidden" name="language_id[]" value="{{$page_category->language_id}}">
                                    <div class="form-group floating-label">
                                        <input type="text" name="category_name[]" value="{{$page_category->category_name}}" class="form-control" id="regular2">
