                ...
                @section('nowosti')
                    ...
                    <div class="page-header row section-to-print">
                        ...
                        <div class="col-md-3 hidden-xs hidden-sm" style="padding-top: 11px;">
                            ...
                            <a class="rss-link pull-right" href="{{URL(\Illuminate\Support\Facades\App::getLocale().'/rss/video')}}"><img src="{{URL('/images/Feed-icon.svg.png')}}" alt="" width="20" height="20"> RSS</a>
                        </div>
                    </div>
                    <br>
                    <div class="row" id="print_all" >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="embed-responsive embed-responsive-16by9">
                                <a href="{{ URL(App::getLocale()."/video/".$value->group."/all") }}" class=""> <img src="{{URL(App::getLocale().'/downloads?type=video&id='.$value->group)}}" alt="" width="100%" height="250"></a>
                            </div>
                        </div>
                        @endforeach
