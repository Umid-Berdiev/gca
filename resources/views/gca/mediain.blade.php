        ...
        <div class="row for_med">
            @foreach($table as $values)
                <div class="col-sm-3 col-4">
                    <div class="over" data-fancybox=":gallery" data-src="{{URL(App::getLocale().'/downloads?type=photoin&id='.$values->id)}}">
                        <img src="{{URL(App::getLocale().'/downloads?type=photoin&id='.$values->id)}}">
