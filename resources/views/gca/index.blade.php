...
" class="card">
          <div class="card-img"><img src="{{ URL(App::getLocale().'/downloads?type=post&id='.$item->group) }}"
              alt="Card image cap">
          </div>
          <div class="card-body">
    ...
    <div class="row">
      <div class="col-lg-6 col-sm-4 left_cal">
        ...
        <div class="events_bottom">
          <a href="{{URL(App::getLocale().'/event/1603263686')}}" class="link_template">@lang('blog.all_events')</a>
      ...
      <div class="col-lg-6 col-sm-8 right_cal">
        ...
        <div class="new_event"
          ...
          <a
            href="{{URL(App::getLocale().'/event/'.$value->event_category_id.'/'.$value->group)}}">{{ $value->title }}</a>
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        <a data-fancybox="" class="videos_fancy over"
          ...
          <img src="https://img.youtube.com/vi/{{ $item->youtube_link}}/sddefault.jpg" alt="">
