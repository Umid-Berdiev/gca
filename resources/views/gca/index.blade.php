    ...
    <div class="swiper-wrapper">
        @foreach($posts as $item)
            <div class="swiper-slide"
                 style="background-image: url({{ URL(App::getLocale().'/downloads?type=post&id='.$item->group) }});">
        ...
        <div class="logotypes_main row justify-content-between no-gutters py-5">
            <div class="col-2">
                <a target="blank" href="https://www.auswaertiges-amt.de/en">
                    <img src="{{asset('GCAlogos/Federal-Foreign-Office.png')}}" alt="logo">
                </a>
            </div>
            <div class="col-2">
                <a target="blank" href="#">
                    <img src="{{asset('GCAlogos/German-cooperation-logo.jpg')}}" alt="logo">
                </a>
            </div>
            <div class="col-2">
                <a target="blank" href="https://www.giz.de">
                    <img src="{{asset('GCAlogos/GIZ-implemented-Logo-Square.jpg')}}" alt="logo">
                </a>
            </div>
            <div class="col-2">
                <a target="blank" href="https://www.dku.kz" target="blank">
                    <img src="{{asset('GCAlogos/DKU.jpg')}}" alt="logo">
                </a>
            </div>
            <div class="col-2">
                <a target="blank"
                   href="https://www.gfz-potsdam.de/ueber-uns/organisation/vorstand-gremien-verwaltung/vorstand/">
                    <img src="{{asset('GCAlogos/GFZ-potsdam.jpg')}}" alt="logo">
                </a>
            </div>
            <div class="col-2">
                <a target="blank" href="https://www.pik-potsdam.de/en/institute?set_language=en">
                    <img src="{{asset('GCAlogos/PIK.jpg')}}" alt="logo">
                </a>
            </div>
        </div>
    </div>
...
<section class="recent_programms">
    <div class="container">
        {{--        <span class="template_span">Signed Documents</span>--}}
        <h2 class="title">@lang('blog.news')</h2>
        <div class="row">
            @foreach($posts_for as $item)
                <div class="col-lg-3 col-sm-6">
                    <a href="{{ URL(App::getLocale().'/posts/'.$item->category_group_id .'/'.$item->group)  }}Read Our Publications
"
                       class="card">
                        <div class="card-img"><img
                                    src="{{ URL(App::getLocale().'/downloads?type=post&id='.$item->group) }}"
                                    alt="Card image cap">
                        </div>
                        <div class="card-body">
...
<section class="wish" style="background-image: url({{asset('project_gca/images/wish.jpg)')}});">
    <div class="container">
        <h2 class="title">@lang('blog.you_must')</h2>
        <a href="{{URL(App::getLocale().'/posts/1603259067')}}" class="link_template">@lang('blog.discover_more')</a>
    </div>
</section>
...
<section class="map_section">
    <div class="container">
        <div class="row" id="apps" v-cloak>
            {{--            <div class="col-md-6">--}}
            {{--                <span class="template_span">@lang('blog.central_asia_map')</span>--}}
            {{--                <h2 class="title">@lang('blog.central_asia_map_text')</h2>--}}
            {{--                <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered--}}
            {{--                    alteration in some form, by injected humour, or randomised words, by injected humour, or randomised--}}
            {{--                    words</p>--}}
            {{--            </div>--}}
...
{{--                <h3>Protect Environment for Our Next Future Generation</h3>--}}
{{--            </div>--}}
{{--            <div class="row">--}}
{{--                <div class="col-sm-3 col-3">--}}
{{--                    <div class="icon_st">--}}
{{--                        <img src="{{asset('project_gca/images/partners1.svg')}}" alt="">--}}
{{--                    </div>--}}
{{--                    <h2>2500</h2>--}}
{{--                    <p>Partners</p>--}}
{{--                </div>--}}
{{--                <div class="col-sm-3 col-3">--}}
{{--                    <div class="icon_st">--}}
{{--                        <img src="{{asset('project_gca/images/partners2.svg')}}" alt="">--}}
{{--                    </div>--}}
{{--                    <h2>600</h2>--}}
{{--                    <p>Projects</p>--}}
{{--                </div>--}}
{{--                <div class="col-sm-3 col-3">--}}
{{--                    <div class="icon_st">--}}
{{--                        <img src="{{asset('project_gca/images/partners3.svg')}}" alt="">--}}
{{--                    </div>--}}
{{--                    <h2>9740</h2>--}}
{{--                    <p>Documents</p>--}}
{{--                </div>--}}
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-4 left_cal">
                ...
                <div class="events_bottom">
                    <a href="{{URL(App::getLocale().'/event/1603263686')}}"
                       class="link_template">@lang('blog.all_events')</a>
            ...
            <div class="col-lg-6 col-sm-8 right_cal">
                @foreach($events as $value)
                    <div class="new_event"
                         onclick="window.location.href='{{URL(App::getLocale().'/event/'.$value->event_category_id)}}'">
                        ...
                        <div class="new_event_date">
                            ...
                            {{\Carbon\Carbon::parse($value->datestart)->format('d.m.Y')}}
                            -{{\Carbon\Carbon::parse($value->dateend)->format('d.m.Y')}}
                        </div>
                        <div class="new_event_adr">
                            <svg width="7" height="11" viewBox="0 0 7 11" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{URL(App::getLocale().'/event/'.$value->event_category_id.'/'.$value->group)}}">{{ $value->title }}</a>
            ...
            @foreach($photos as $item)
                <div class="swiper-slide">
                    <div class="over" data-fancybox=":gallery"
                         data-src="{{URL(App::getLocale().'/downloads?type=photoin&id='.$item->id)}}">
                        <img src="{{URL(App::getLocale().'/downloads?type=photoin&id='.$item->id)}}">
