                ...
                <div class="shadoves">
                    <div class="new_event">
                        <div class="new_event_date">
                            ...
                            {!! \Carbon\Carbon::parse($value->datestart)->format('d.m.Y') !!}- {!! \Carbon\Carbon::parse($value->dateend)->format('d.m.Y') !!}
                        </div>
                        ...
                        <a href="{{ URL(App::getLocale().'/event/'.$curcat->group.'/'.$value->group) }}">{{ $value->title }}</a>
