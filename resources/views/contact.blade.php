                    ...
                    <div class="container-fluid text-left">
                        ...
                        <form action="{{URL('/contact_post')}}" method="post">
                            ...
                            <div class="form-group">
                                <label for="">@lang('blog.full_name')<span class="fio">*</span>:</label>
                                <input type="text" value="" name="fio" title="" placeholder="@lang('blog.full_name_placeholder')" class="form-control" id="">
                            </div>
                            <div class="form-group">
                                <label for="">@lang('blog.email') <span class="required">*</span>:</label>
                                <input type="email" value="" name="email" title="" placeholder="@lang('blog.email_placeholder')" class="form-control" id="">
                            </div>
                            <div class="form-group">
                                <label for="">@lang('blog.message_text')<span class="required">*</span>:</label>
                                <textarea resize="no" name="comment" cols="25" rows="5" title="" placeholder="@lang('blog.message_text_placeholder')" class="form-control textarea" id=""></textarea>
                            </div>
                            <!--<div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary" value="@lang('blog.form_btn_send')">
                            </div>
