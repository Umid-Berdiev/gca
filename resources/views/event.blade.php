                ...
                @section('nowosti')
                    ...
                    <div class="page-header row">
                        ...
                        <div class="col-md-3 hidden-xs hidden-sm" style="padding-top: 11px;">
                            ...
                            <a class="rss-link pull-right" href="{{URL(\Illuminate\Support\Facades\App::getLocale().'/rss/event')}}"><img src="{{URL('/images/Feed-icon.svg.png')}}" alt="" width="20" height="20"> RSS</a>
                        </div>
                    </div>
                    <br>
                    @if ($errors->any())
                        ...
                        <form action="{{URL(App::getLocale().'/events/filter')}}" method="get" name="tenders_archive_filter">
                            ...
                            <table width="100%" class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{URL(App::getLocale().'/event/'.$curcat->group)}}"  name="clear"  class="btn btn-warning">Тозалаш</a></td>
                                </tr>
                                </tbody>
                            </table>
                        </form>
                        ...
                        <div class="item page-header">
                            <div class="row">
                                <div class="col-md-3 col-sm-4">
                                    <a href="{{ URL(App::getLocale().'/event/'.$curcat->group.'/'.$value->group) }}"><img class="img-responsive" src="{{URL(App::getLocale().'/downloads?type=event&id='.$value->group)}}"></a>
                                ...
                                <div class="col-md-9 col-sm-8 section-to-print">
                                    ...
                                    <h4><a href="{{ URL(App::getLocale().'/event/'.$curcat->group.'/'.$value->group) }}">{{ $value->title }}</a></h4>
                                    <div class="row">
                                        <div class="col-sm-4"><p class="small">Ташкилотчи: <span class="text-primary">{{ $value->organization }}</span></p></div>
                    ...
                    <div class="col menu-item-structure">
                        ...
                        <div class="list-group">
                            @foreach($newscat as $value)
                                ...
                                <a href="{{ URL(App::getLocale().'/event/'.$value->group) }}" class="list-group-item active">{{$value->category_name}}</a>
                                @else
