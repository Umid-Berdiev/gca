                ...
                @section('nowosti')
                    ...
                    <div class="page-header row section-to-print">
                        ...
                        <div class="col-md-3 hidden-xs hidden-sm" style="padding-top: 11px;">
                            ...
                            <a class="rss-link pull-right" href="{{URL(\Illuminate\Support\Facades\App::getLocale().'/rss/photo')}}"><img src="{{URL('/images/Feed-icon.svg.png')}}" alt="" width="20" height="20"> RSS</a>
                        </div>
                    </div>
                    <br>
                    <div class="row" id="print_all">
                        @foreach($table as $value)
                            <div class="col-md-4">
                                <a href="{{ URL(App::getLocale()."/photo/".$value->group."/all") }}"><img src="{{URL(App::getLocale().'/downloads?type=photo&id='.$value->group)}}" alt="" class="img-responsive"></a>
                                <h4><a href="{{ URL(App::getLocale()."/photo/".$value->group."/all") }}"><b>{{$value->title}}</b></a></h4>
