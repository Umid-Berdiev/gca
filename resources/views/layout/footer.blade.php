        ...
        <div class="col-md-4 col-sm-6  col-xs-12">
          ...
          <form class="form-horizontal" action="{{URL('/obuna')}}" method="post">
            ...
            <div class="form-group col-xs-12">
              <input type="email" class="form-control" id="exampleInputEmail2" name="email" placeholder="@lang('blog.email_push')">
            </div>
            <div class="form-group col-xs-12">
            ...
            <div class="col-md-6">
              <div class="row center-block">
                <div>
                  ...
                  <p><span class="lastmodify">@lang('blog.last_update') {{date_format($date,"d.m.Y")}} y. | {{date_format($date,"H:i")}}</span></p>
                </div>
                <div>
