    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="{{ URL(App::getLocale()."/") }}"><span class="sr-only">(current)</span><span class="glyphicon glyphicon-home"></span></a></li>
                    ...
                    @if(count($modelsx) >0)
                        <li class="dropdown">
							...
							@else       {{ URL(App::getLocale().$valuexx->link) }}     @endif
                                                        ...
                                                        @endif"><span class="title">{{ $valuexx->menu_name }}</span></a></li>
...
$mystring = $valuex->link; $findme = 'http'; $pos = strpos($mystring, $findme);
    if ($pos === false) {
     ...
     echo $valuex->link;
                                            ...
                                            @endif"><span class="title">{{ $valuex->menu_name }}</span></a></li>
											<li role="separator" class="divider"></li>
                    ...
                    @else
                        <li><a href="@if($value->type =="1")
                           ...
                           @endif"><span class="title">{{ $value->menu_name }}</span></a></li>
						   <li role="separator" class="divider"></li>
                    @endif
                @endforeach
                            ...
                            <li aria-labelledby="dropdownMenu1" role="presentation">
                                <form action="{{URL(App::getLocale().'/search')}}" class="navbar-form" style="width: max-content;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="search" autocomplete="off" class="form-control" id="exampleInputName2" placeholder="@lang('blog.search-placeholder')" maxlength="50">
                                    </div>
