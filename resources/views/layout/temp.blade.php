      ...
      <div class="container">
        <div class="header-panel">
            <div class="row">
              <div class="col-sm-8 col-xs-6">
                <a href="/" class="btn mobile-link hidden-sm btn-open-adaptive hidden-xs hidden-sm"><span class="glyphicon glyphicon-phone"></span><span class="hidden-xs">@lang('blog.mobile_version')</span></a>
                <button class="specialversion btn"><span class="glyphicon glyphicon-eye-open"></span><span class="hidden-xs hidden-sm">@lang('blog.blind')</span></button>
                <a href="#" class="btn sitemap-link"><span class="glyphicon glyphicon-globe"></span><span class="hidden-xs hidden-sm"> @lang('blog.map')</span></a>
              </div>
              <div class="col-sm-4 col-xs-6 text-right">
                <div class="lang-menu">
                @section('lan')
                  <a href="/home" class="btn auth-link"><span class="glyphicon glyphicon-log-in"></span><span class="hidden-xs hidden-sm">@lang('blog.enter')</span></a>
                    @foreach(\App\language::all() as $key=>$language)
                      @if(App::getLocale() == $language->language_prefix)
                    <a href="{{URL('/locale/'.$language->language_prefix)}}" class="btn lang selected"><span class="hidden-xs">{{$language->language_name}}</span><span class="visible-xs">{{$language->language_prefix}}</span></a>
                      @else
                        <a href="{{URL('/locale/'.$language->language_prefix)}}" class="btn lang "><span class="hidden-xs">{{$language->language_name}}</span><span class="visible-xs">{{$language->language_prefix}}</span></a>
                    @endif
                    @endforeach
                @show
                </div>
        ...
        <div class="row hidden-xs">
            <div class="col-sm-3 col-md-2">
              <a href="{{URL('/')}}"><img src="{{URL('images/flag_gerb_uz.png')}}" alt="" class="img-responsive" width="190"></a>
            </div>
    ...
    @section('footer')
      <footer id="footer">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6  col-xs-12">
                ...
                <form class="form-horizontal">
                  ...
                  <div class="form-group col-xs-12">
                    <button type="submit" class="btn btn-primary btn-block" style="padding-top: 10px; padding-bottom: 10px">@lang('blog.obuna_bulish')</button>
                  </div>
                </form>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xs-8">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <span class="counters">
                    <a href="http://my.gov.uz"><img src="{{URL('images/mygovuz.jpg')}}" width="88" height="31" title="Единый портал интерактивных государственных услуг" alt="My.gov.uz"></a>
                    <a href="/uz/PKM_675/"><img src="{{URL('images/pkm.png')}}" width="88" height="31" title="ПКМ №675 от 31.12.2013 г." alt="ПКМ №675 от 31.12.2013 г."></a>
              ...
              <div class="col-md-4 col-xs-3">
                <div class="row text-right">
                  <div class="col-xs-12">
                    <a href="http://kibera.uz" title="Kibera">@lang('blog.creator'): <img src="{{URL('images/logo-kibera.png')}}" title="kibera.uz" alt="kibera.uz" width="95" height="30"></a><br/><br/>
                  </div>
                </div>
              </div>
            </div><!-- .row -->
        ...
        <div class="container-fluid text-center" style="background-color: #063E78">
          <h6>© 2018 - <script>document.write(new Date().getFullYear());</script> | @lang('blog.company_name')</h6>
        </div>
      </footer>
    @show
</body>
