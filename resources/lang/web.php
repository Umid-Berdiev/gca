...
Route::group(['middleware' => ['ipcheck'], 'prefix' => 'admin'], function() {
    ...
    Route::get('doccategory', 'admin\DoccategoryController@index')->name('doccategory')->middleware(['auth', 'isAuther']);
    Route::post('doccategory/edit', 'admin\DoccategoryController@Update')->middleware(['auth', 'isAuther']);
    Route::get('doccategory/edit', 'admin\DoccategoryController@UpdateShow')->name('doccategory_edit')->middleware(['auth', 'isAuther']);
    Route::get('doccategory/delete', 'admin\DoccategoryController@Delete')->name('doccategory_delete')->middleware(['auth', 'isAuther']);
    Route::get('doccategory/create', 'admin\DoccategoryController@InsertShow')->name('doccategory_create')->middleware(['auth', 'isAuther']);
    Route::post('doccategory/insert', 'admin\DoccategoryController@Insert')->middleware(['auth', 'isAuther']);
    ...
    Route::get('videocategory', 'admin\VideocategoryController@index')->name('videocategory')->middleware(['auth', 'isAuther']);
    Route::post('videocategory/edit', 'admin\VideocategoryController@Update')->middleware(['auth', 'isAuther']);
    Route::get('videocategory/edit', 'admin\VideocategoryController@UpdateShow')->name('videocategory_edit')->middleware(['auth', 'isAuther']);
    Route::get('videocategory/delete', 'admin\VideocategoryController@Delete')->name('videocategory_delete')->middleware(['auth', 'isAuther']);
    Route::get('videocategory/create', 'admin\VideocategoryController@InsertShow')->name('videocategory_create')->middleware(['auth', 'isAuther']);
    Route::post('videocategory/insert', 'admin\VideocategoryController@Insert')->middleware(['auth', 'isAuther']);
    ...
    Route::get('doc', 'admin\DocController@index')->name('doc')->middleware(['auth', 'isAuther']);
    Route::post('doc/edit', 'admin\DocController@Update')->middleware(['auth', 'isAuther']);
    Route::get('doc/edit', 'admin\DocController@UpdateShow')->name('doc_edit')->middleware(['auth', 'isAuther']);
    Route::get('doc/delete', 'admin\DocController@Delete')->name('doc_delete')->middleware(['auth', 'isAuther']);
    Route::get('doc/create', 'admin\DocController@InsertShow')->name('doc_create')->middleware(['auth', 'isAuther']);
    Route::post('doc/insert', 'admin\DocController@Insert')->middleware(['auth', 'isAuther']);
