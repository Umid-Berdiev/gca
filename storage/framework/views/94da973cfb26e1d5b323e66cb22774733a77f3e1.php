...
<div class="card-body" style="background-color: white">
  <div class="col-md-12">
    ...
    <form class="form" role="form" enctype="multipart/form-data" method="post" action="<?php echo e(URL("/admin/photocategory/edit")); ?>">
              ...
              <?php if ($val->language_id == $language->id) : ?>
                <div class="tab-pane active" id="<?php echo e($language->id); ?>">
                  <div class="form" role="form">
                    ...
                    <div class="form-group floating-label">
                      <input type="text" name="descriptions[]" class="form-control" value="<?php echo e($val->Description); ?>" id="regular2">
...
<?php echo $__env->make("admin.layout.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\admin\photocategory_edit.blade.php ENDPATH**/ ?>