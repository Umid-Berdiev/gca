            ...
            <div class="row">
                <?php $__env->startSection('nowosti'); ?>
                    ...
                    <?php $__currentLoopData = $table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-3">
                            <a class="example-image-link " href="<?php echo e(URL(App::getLocale().'/downloads?type=photoin&id='.$values->id)); ?>" data-lightbox="example-set" data-title="<?php echo e($values->description); ?>"><img height="150" width="100%" class="example-image" src="<?php echo e(URL(App::getLocale().'/downloads?type=photoin&id='.$values->id)); ?>" alt="" /></a>
                        </div>
...
<?php echo $__env->make('layout.defualt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\mediaphotoin.blade.php ENDPATH**/ ?>