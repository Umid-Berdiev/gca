                        ...
                        <?php if($key == 0): ?>
                            <div class="tab-pane active" id="<?php echo e($page_category->language_id); ?>">
                                <div class="form" role="form">
                                    ...
                                    <input type="hidden" name="language_id[]" value="<?php echo e($page_category->language_id); ?>">
                                    <div class="form-group floating-label">
                                        <input type="text" name="category_name[]" value="<?php echo e($page_category->category_name); ?>" class="form-control" id="regular2">
