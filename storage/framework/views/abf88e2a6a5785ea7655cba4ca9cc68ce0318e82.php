...
" class="card">
          <div class="card-img"><img src="<?php echo e(URL(App::getLocale().'/downloads?type=post&id='.$item->group)); ?>"
              alt="Card image cap">
          </div>
          <div class="card-body">
    ...
    <div class="row">
      <div class="col-lg-6 col-sm-4 left_cal">
        ...
        <div class="events_bottom">
          <a href="<?php echo e(URL(App::getLocale().'/event/1603263686')); ?>" class="link_template"><?php echo app('translator')->getFromJson('blog.all_events'); ?></a>
      ...
      <div class="col-lg-6 col-sm-8 right_cal">
        ...
        <div class="new_event"
          ...
          <a
            href="<?php echo e(URL(App::getLocale().'/event/'.$value->event_category_id.'/'.$value->group)); ?>"><?php echo e($value->title); ?></a>
...
<section class="media_section">
  <div class="swiper-container swiper_media for_med">
    <div class="swiper-wrapper">
      <?php $__currentLoopData = $media_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if(isset($item->youtube_link)): ?>
      <div class="swiper-slide">
        <a data-fancybox="" class="videos_fancy over"
          href="https://www.youtube.com/watch?v=<?php echo e($item->youtube_link); ?>&amp;feature=emb_logo"
          data-caption="<?php echo e($item->description); ?>">
          <img src="https://img.youtube.com/vi/<?php echo e($item->youtube_link); ?>/sddefault.jpg" alt="">
  ...
  let app = new Vue({
            ...
            methods: {
                ...
                getGcaInfo: function (prefix) {
                  axios
                    .get("<?php echo e(route('gca.info.get')); ?>", {
                      params: {
                        prefix: prefix
                      }
                    })
