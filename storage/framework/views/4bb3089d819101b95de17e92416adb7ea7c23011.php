...
<h3 > TITLE</h3>
                        <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <input class="hidden" name="language_id[]" value="<?php echo e($value->id); ?>">
                            <div class="col-md-3">
                        <div class="form-group">
                            <h4><?php echo e($value->language_prefix); ?></h4>
                            <input class="form-control" name="title[]" value="<?php echo e($json->title[$key]); ?>">
...
<?php switch($value->language_prefix):
    ...
    case ("uz"): ?>
                                        ...
                                        <?php case ("ru"): ?>
                                        <?php $__currentLoopData = $json->tb_one_ru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php case ("en"): ?>
                                        <?php $__currentLoopData = $json->tb_one_en; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div style="margin: 40px;" id="<?php echo e($value->id); ?><?php echo e($key); ?>x">
