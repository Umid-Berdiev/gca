                    ...
                    <div class="page-content">
                        <div>
                            <ol class="breadcrumb h6">
                                ...
                                <li><a href="<?php echo e(URL(App::getLocale().'/video/')); ?>"><?php echo app('translator')->getFromJson('blog.video'); ?></a></li>
                            </ol>
                        </div>
                    </div>
...
<?php echo $__env->make('layout.defualt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\media.blade.php ENDPATH**/ ?>