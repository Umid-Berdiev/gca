...
<div class="card-body" style="background-color: white">
  <div class="col-md-12">
    ...
    <form class="form" role="form" enctype="multipart/form-data" method="post"
      action="<?php echo e(route('post-categories.store')); ?>">
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make("admin.layout.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views/admin/post_category/create.blade.php ENDPATH**/ ?>