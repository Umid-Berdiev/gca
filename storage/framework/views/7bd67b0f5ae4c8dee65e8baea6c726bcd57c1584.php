                ...
                <?php $__env->startSection('nowosti'); ?>
                    <div class="page-content">
                        <div>
                            <ol class="breadcrumb h6">
                                ...
                                <li><a href="<?php echo e(URL(App::getLocale().'/statistica')); ?>" title="<?php echo app('translator')->getFromJson('blog.statistica'); ?>"><?php echo app('translator')->getFromJson('blog.statistica'); ?></a></li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row" id="print_all" >
                        ...
                        <?php $__currentLoopData = $table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6">
                                <a class="example-image-link " href="<?php echo e(URL(App::getLocale().'/downloads?type=statistica&id='.$values->id)); ?>" data-lightbox="example-set" data-title="<?php echo e($values->description); ?>"><img height="200" width="100%" class="example-image" src="<?php echo e(URL(App::getLocale().'/downloads?type=statistica&id='.$values->id)); ?>" alt="" /></a>
                            </div>
                ...
                <div class="col-md-3" style="padding-top: 50px;">
                    <div class="col menu-item-structure">
                        <div class="col" style="background-color: #3075ff; padding: 5px 15px; color: #fff">
                            <h4><?php echo app('translator')->getFromJson('blog.statistica'); ?></h4>
                        </div>
...
<?php echo $__env->make('layout.defualt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\statistica.blade.php ENDPATH**/ ?>