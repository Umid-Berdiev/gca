      ...
      <div class="card-body tab-content">
        ...
        <div class="form-group">
          <select class="form-control" id="select1" name="categories">
            ...
            $__env->addLoop($__currentLoopData);
            foreach ($__currentLoopData as $key => $categories) : $__env->incrementLoopIndices();
              $loop = $__env->getLastLoop(); ?>
          ...
          <?php if ($key == 0) : ?>
            <div class="tab-pane active" id="<?php echo e($languages[$key]->id); ?>">
              <div class="form" role="form">
                ...
                <input type="hidden" name="language_ids[]" value="<?php echo e($languages[$key]->id); ?>">
                <input type="hidden" name="page_id[]" value="<?php echo e($pages[$key]->id); ?>">
                <div class="form-group floating-label">
                  <input type="text" name="titles[]" value="<?php echo e($pages[$key]->title); ?>" class="form-control" id="regular2">
