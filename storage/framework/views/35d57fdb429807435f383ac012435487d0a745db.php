        ...
        <div class="table-responsive">
            <div class="card">
                ...
                <div class="card-body tab-content">
                                ...
                                <form class="form-horizontal" role="form" method="post" action="<?php echo e(URL("admin/language/insert")); ?>">
...
<?php echo $__env->make("admin.layout.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views/admin/langinser.blade.php ENDPATH**/ ?>