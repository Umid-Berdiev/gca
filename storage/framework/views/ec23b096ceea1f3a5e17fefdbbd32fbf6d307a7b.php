...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("assets/css/theme-default/materialadmin.css?1425466319")); ?>" />
  <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("assets/css/theme-default/font-awesome.min.css?1422529194")); ?>" />
  <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("assets/css/theme-default/material-design-iconic-font.min.css?1421434286")); ?>" />
      ...
      <div class="menubar-scroll-panel">
        ...
        <ul id="main-menu" class="gui-controls">
          ...
          <?php if ($user->status  == 1) : ?>
            <?php if (
              'languages' == Route::current()->getName() ||
          ...
          <li class="gui-folder" id="pager">
            ...
            <ul>
              ...
              <?php if (
                ...
                <li class="active">
                  <a href="<?php echo e(URL('/admin/post/')); ?>">
          ...
          <li class="gui-folder" id="pager">
            ...
            <ul>
              <?php if (
                ...
                <li class="active">
                  <a href="<?php echo e(URL('/admin/doccategory/')); ?>">
              ...
              <?php if (
                ...
                <li class="active">
                  <a href="<?php echo e(URL('/admin/doc/')); ?>">
                    <span class="title">Документы</span>
                  </a>
                </li>
              <?php else : ?>
          ...
          <li class="gui-folder" id="pager">
            ...
            <ul>
              <?php if (
                ...
                <li class="active">
                  <a href="<?php echo e(URL('/admin/photocategory/')); ?>">
              ...
              <?php if (
                ...
                <li class="active">
                  <a href="<?php echo e(URL('/admin/photo/')); ?>">
          ...
          <li class="gui-folder" id="pager">
            <?php if (
              Route::current()->getName() == 'videoalbum' ||
            ...
            <ul>
              <?php if (
                ...
                <li class="active">
                  <a href="<?php echo e(URL('/admin/videoalbum/')); ?>">
              ...
              <?php if (
                ...
                <li class="active">
                  <a href="<?php echo e(URL('/admin/video/')); ?>">
          ...
          <li class="gui-folder" id="pager">
            <?php if (
              'page_categories' == Route::current()->getName()
...
<?php /**PATH D:\OpenServer\domains\gca\resources\views\admin\layout\template.blade.php ENDPATH**/ ?>