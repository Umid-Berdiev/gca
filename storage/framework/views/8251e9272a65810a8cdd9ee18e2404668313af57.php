<?php $__env->startSection("content"); ?>
    ...
    <div class="card-body" style="background-color: white">
        ...
        <div class="col-md-12">
            ...
            <form class="form" role="form" enctype="multipart/form-data" method="post" action="<?php echo e(URL("/admin/video/insert")); ?>">
                            ...
                            <div class="tab-pane active" id="<?php echo e($language->id); ?>">
                                <div class="form" role="form">
                                    ...
                                    <div class="form-group floating-label">
                                        ...
                                        <label for="post_category_id">Photo category</label>
                                    </div>
                                    <div class="form-group floating-label">
...
<?php echo $__env->make("admin.layout.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\admin\video_add.blade.php ENDPATH**/ ?>