...
$events = \DB::table("events")
  ...
  ->where('events.title', '<>', '')
  ->where("events.language_id", "=", \App\Http\Controllers\SearchController::languages())
  ->where("eventcategories.language_id", "=", \App\Http\Controllers\SearchController::languages())->take(5)->get();
?>
...
<head>
  ...
  <?php if (\Illuminate\Support\Facades\App::getLocale() == 'uz') : ?>
    <script src="<?php echo e(URL::asset('main_uz.js')); ?>"></script>
  <?php elseif (\Illuminate\Support\Facades\App::getLocale() == 'ru') : ?>
    <script src="<?php echo e(URL::asset('main_ru.js')); ?>"></script>
  <?php else : ?>
    <script src="<?php echo e(URL::asset('main_en.js')); ?>"></script>
  <?php endif; ?>
  <script src="<?php echo e(URL('js/responsivevoice.js')); ?>"></script>
  <script src="<?php echo e(URL('js/orphus.js')); ?>"></script>
  ...
  <div class="special-settings">
    <div class="special-settings-wrapper clearfix container">
      ...
      <div class="norm-version col-md-4">
        <a href="<?php echo e('/' . URL(App::getLocale())); ?>" id="normalversion" data-set="normalversion" title="Полная версия сайта">Сайтни тўлиқ нусхаси</a>
      </div>
    ...
    <div class="container">
      <div class="header-panel">
        <div class="row">
          <div class="col-sm-8 col-xs-5" id="app">
            <a href="#" class="btn mobile-link hidden-sm btn-open-adaptive hidden-xs hidden-sm" onclick="openWin();resizeWinTo();"><span class="glyphicon glyphicon-phone" style="font-size:16px;"></span><span class="hidden-xs" style="vertical-align:text-bottom;">
                <?php echo app('translator')->getFromJson('blog.mobile_version'); ?></span></a>
            <button class="specialversion btn"><span class="glyphicon glyphicon-eye-open" style="font-size:16px;"></span><span class="hidden-xs hidden-sm" style="vertical-align:text-bottom;">
                <?php echo app('translator')->getFromJson('blog.blind'); ?></span></button>

            <a href="#" v-if="readCookie('voice') == 'off'" id="voices" class="btn sitemap-link voices" title="Овозли матн"><span class="glyphicon glyphicon-volume-off" style="font-size:18px;"></span><span class="hidden-xs hidden-sm" style="vertical-align:text-bottom;"> <?php echo app('translator')->getFromJson('blog.voice'); ?></span></a>
            <a href="#" v-else="readCookie('voice') == 'on'" id="voices" class="btn sitemap-link voices" title="Овозли матн"><span class="glyphicon glyphicon-volume-up" style="font-size:18px;"></span><span class="hidden-xs hidden-sm" style="vertical-align:text-bottom;"> <?php echo app('translator')->getFromJson('blog.voice'); ?></span></a>


            <a href="<?php echo e(URL(App::getLocale() . '/map')); ?>" class="btn sitemap-link"><span class="glyphicon glyphicon-globe" style="font-size:16px;"></span><span class="hidden-xs hidden-sm" style="vertical-align:text-bottom;">
                <?php echo app('translator')->getFromJson('blog.map'); ?></span></a>
          </div>
          <div class="col-sm-4 col-xs-7 text-right">
            <div class="lang-menu">
              <?php $__env->startSection('lan'); ?>
              <a href="/admin" class="btn auth-link"><span class="glyphicon glyphicon-log-in"></span><span class="hidden-xs hidden-sm"> <?php echo app('translator')->getFromJson('blog.enter'); ?></span></a>
              <?php $__currentLoopData = \App\Language::all();
              ...
              foreach ($__currentLoopData as $key => $language) : $__env->incrementLoopIndices();
                ...
                <?php if (App::getLocale() == $language->language_prefix) : ?>
                  <a href="<?php echo e(str_replace("/" . App::getLocale(), "/" . $language->language_prefix, URL::current())); ?>" class="btn lang selected"><span class="hidden-xs"><?php echo e($language->language_name); ?></span><span class="visible-xs"><?php echo e($language->language_prefix); ?></span></a>
                <?php else : ?>
                  <a href="<?php echo e(str_replace("/" . App::getLocale(), "/" . $language->language_prefix, URL::current())); ?>" class="btn lang "><span class="hidden-xs"><?php echo e($language->language_name); ?></span><span class="visible-xs"><?php echo e($language->language_prefix); ?></span></a>
                <?php endif; ?>
              <?php endforeach;
              $__env->popLoop();
              $loop = $__env->getLastLoop(); ?>
      ...
      <div class="row hidden-xs">
        <div class="col-sm-3 col-md-2 logo">
          <a href="<?php echo e(URL(App::getLocale() . '/')); ?>"><img src="<?php echo e(URL('/images/flag_gerb_uz.png')); ?>" alt="" class="img-responsive" width="190"></a>
        </div>
        <div class="col-sm-6 site-name">
          <h2><a href="<?php echo e(URL('/' . App::getLocale())); ?>" title="ЎзРес Сув хўжалиги вазирлиги"><?php echo app('translator')->getFromJson('blog.company_name'); ?></a></h2>
        </div>
      </div>
      <div class="row visible-xs">
        ...
        <div class="col-xs-8" style="padding-top: 10px">
          <div class="site-name">
            <h5><a href="<?php echo e(URL(App::getLocale() . '/')); ?>"><?php echo app('translator')->getFromJson('blog.company_name'); ?></a></h5>
          </div>
        </div>
      </div>
    </div><!-- .container -->
      ...
      <div class="container">
        ...
        <div class="row"><br />
            ...
            <div class="row">
              ...
              <div class="col-sm-3 hidden-xs sidenav">
                <div class="left-sidebar">
                  <h5><?php echo app('translator')->getFromJson('blog.activity'); ?></h5>
                ...
                <!-- <div class="left-sidebar">
                    <h5><?php echo app('translator')->getFromJson('blog.events'); ?></h5>
                    <div class="list-group">
                    <?php $__env->startSection('tadbirlar'); ?>
                      <a href="#" class="list-group-item"><img src="<?php echo e(URL('/images/irrigation.png')); ?>" alt="" width="30" height="30" /><p>Ирригация</p></a>

                    <?php echo $__env->yieldSection(); ?>
                    </div>
                  </div>-->
                <div class="container-fluid useful-btns">
                  <a href="<?php echo e(URL(App::getLocale() . '/doc/1546094482')); ?>" class="" style="color: #fff">
                    <div class="row" style="display: flex; height: 70px; align-items: center; justify-content: center;">
                      <div class="col-sm-2"><img src="<?php echo e(URL('/images/law_books.png')); ?>" alt=""></div>
                      <div class="col-sm-9">
                        <p style="margin: 5px 5px"><?php echo app('translator')->getFromJson('blog.docs'); ?></p>
                      </div>
                    </div>
                  </a>
                </div><br />
                <div class="container-fluid useful-btns">
                  <a href="#" class="" style="color: #fff">
                    <div class="row" style="display: flex; height: 70px; align-items: center; justify-content: center;">
                      <div class="col-sm-2"><img src="<?php echo e(URL('/images/interaktiv.png')); ?>" alt=""></div>
                      <div class="col-sm-9">
                        <p style="margin: 5px 5px"><?php echo app('translator')->getFromJson('blog.interactive'); ?></p>
                      </div>
                    </div>
                  </a>
                </div><br />
                <div class="container-fluid useful-btns">
                  <a href="#" class="" style="color: #fff">
                    <div class="row" style="display: flex; height: 70px; align-items: center; justify-content: center;">
                      <div class="col-sm-2"><img src="<?php echo e(URL('/images/murojaatlar.png')); ?>" alt=""></div>
                      <div class="col-sm-9">
                        <p style="margin: 5px 5px"><?php echo app('translator')->getFromJson('blog.currently'); ?></p>
                      </div>
                    </div>
                  </a>
                </div><br />
                <div class="container-fluid useful-btns">
                  <a href="#" class="" style="color: #fff">
                    <div class="row" style="display: flex; height: 70px; align-items: center; justify-content: center;">
                      <div class="col-sm-2"><img src="<?php echo e(URL('/images/maslahatlar.png')); ?>" alt=""></div>
                      <div class="col-sm-9">
                        <p style="margin: 5px 5px"><?php echo app('translator')->getFromJson('blog.interpretations'); ?></p>
                      </div>
                    </div>
                  </a>
                </div>
            ...
            <div class="statistika col-xs-12">
              <div class="row" style="background-color: #fff">
                <div class="col-xs-12" style="padding: 10px 0 0 30px;">
                  <h4><b><?php echo app('translator')->getFromJson('blog.statistica'); ?></b></h4>
                </div>
                <div id="statCarousel" class="carousel slide" data-ride="carousel">
                  <!-- Indicators -->
                  <ol class="carousel-indicators">
                    <?php $__currentLoopData = $statisticas;
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $key => $statistica) : $__env->incrementLoopIndices();
                      $loop = $__env->getLastLoop(); ?>
                      <?php if ($key == 0) : ?>
                        <li data-target="#statCarousel" data-slide-to="<?php echo e($key); ?>" class="active"></li>
                      <?php else : ?>
                        <li data-target="#statCarousel" data-slide-to="<?php echo e($key); ?>"></li>
                      <?php endif; ?>
                    <?php endforeach;
                    $__env->popLoop();
                    $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="carousel-inner" role="listbox">
                    ...
                    foreach ($__currentLoopData as $key => $statistica) : $__env->incrementLoopIndices();
                      ...
                      <?php if ($key == 0) : ?>
                        <div class="item active">
                          <img class="img-responsive center-block" src="<?php echo e(URL(App::getLocale() . '/downloads?type=statistica&id=' . $statistica->id)); ?>" alt="<?php echo e($statistica->name); ?>">
                        </div>
                      <?php else : ?>
                        <div class="item">
                          <img class="img-responsive center-block" src="<?php echo e(URL(App::getLocale() . '/downloads?type=statistica&id=' . $statistica->id)); ?>" alt="<?php echo e($statistica->name); ?>">
                    ...
                    <!--<div class="item">
                        <img class="img-responsive center-block" src="<?php echo e(URL('/images/87c42995a2ddfbaa456cc6d324abff47.jpg')); ?>" alt="Uzb">
                      </div>
          ...
          <div class="col-sm-3" style="float: right">
            <div class="col">
              <img class="img-responsive" src="<?php echo e(URL('/images/banner-home-yilnomi.png')); ?>" alt="" />
            </div>
            <br />
            <div class="col request-to-minister">
              <div class="col blue-header">
                <h4><?php echo app('translator')->getFromJson('blog.ministr'); ?></h4>
              </div>
              <div class="col">
                <a href="https://pm.gov.uz/uz#/authorities/1/191/_apply"><img class="img-responsive" src="<?php echo e(URL('/images/vazirga-murojaat-banneri.png')); ?>" alt="" /></a>
              </div>
            </div>
            <!-- Sidebar/Эълонлар блоги-->
            <!--<div class="col menu-item-structure">
                  <div class="col text-center">
                    <h4><?php echo app('translator')->getFromJson('blog.deals'); ?></h4>
                  </div>
                  <div class="well-sm" style="background-color: white;">
                    <?php $__env->startSection('elonlar'); ?>
                    <div class="row">
                      <div class="col-xs-4" style="padding-top: 10px">
                        <a href="#"><img class="center-block" src="<?php echo e(URL('/images/main-5bb2888b-4cfb-453a-ba1f-8e0ad73854e4.jpeg')); ?>" alt="" width="77" height="63"></a>
                      </div>
                      <div class="col-xs-8">
                        <a href="#"><h6><?php echo app('translator')->getFromJson('blog.education'); ?></h6></a>
                      </div>
                    </div>
                    <?php echo $__env->yieldSection(); ?>
                  </div>
            ...
            <div class="events-widget">
              <div class="col force-margin">
                <div class="col text-center blue-header">
                  <h4><?php echo app('translator')->getFromJson('blog.events'); ?></h4>
                </div>
                <div class="well-sm" style="background-color: white;">
                  ...
                  foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
                    ...
                    <div class="row">
                      <div class="col-xs-4" style="padding-top: 10px">
                        <a href="<?php echo e(URL(App::getLocale() . '/event/' . $value->event_category_id)); ?>"><img class="center-block" src="<?php echo e(URL(App::getLocale() . '/downloads?type=event&id=' . $value->group)); ?>" width="77" height="63"></a>
                      </div>
                      <div class="col-xs-8">
                        <a href="<?php echo e(URL(App::getLocale() . '/event/' . $value->event_category_id)); ?>">
            ...
            <div class="col tenders">
              <div class="col-xs-12 text-center blue-header">
                <h4><?php echo app('translator')->getFromJson('blog.tender'); ?></h4>
              </div>
              <div class="well-sm force-margin" style="background-color: white;">
                ...
                <div class="row">
                  <div class="col-xs-4" style="padding-top: 10px">
                    <a href="#"><img class="img-responsive center-block" src="<?php echo e(URL('/images/CandidateManagement.png')); ?>" alt=""></a>
                  </div>
                  <div class="col-xs-8">
                    <a href="#">
                      <h6><?php echo app('translator')->getFromJson('blog.vacan'); ?></h6>
                    </a>
                  </div>
                </div><!-- .row -->
                <div class="row">
                  <div class="col-xs-4" style="padding-top: 5px">
                    <a href="#"><img class="img-responsive center-block" src="<?php echo e(URL('/images/water-intensiv.png')); ?>" alt=""></a></div>
                  <div class="col-xs-8">
                    <a href="#">
                      <h6><?php echo app('translator')->getFromJson('blog.new_technoligy'); ?></h6>
                    </a>
                  </div>
                </div>
                <?php echo $__env->yieldSection(); ?>
            ...
            <div class="survey-widget">
              ...
              <?php echo $__env->make('layout.sorov', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="currency-widget ">
              ...
              <?php echo $__env->make("layout.kurs", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            </div>
            <div class="weather-widget ">

              <?php echo $__env->make("layout.weather", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
          ...
          <div class="col-sm-12 media-blok">
            ...
            <?php echo $__env->make('layout.photovideo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <div id="locals" class="container-fluid">
    <div class="row" style="background-color: #D4E2EA; opacity: 0.7; padding: 50px;">
      <div class="container text-center">
        ...
        <div class="col-sm-4">
          <h4 style="color: #000;"><b><?php echo app('translator')->getFromJson('blog.local_department'); ?></b></h4>
        </div>
        <div class="col-sm-4 hidden-xs">
          <hr />
        </div>
      ...
      <div class="col-md-6">
        <svg id="map" version="1.1" viewBox="0 0 700 450" height="300pt" width="500pt" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <path class="map-highlight" fill="#d01a20" stroke="#fff" stroke-width="1" id="uz_tk" aria-selected="true" d="M543.4,224.6 L538.8,229.3 L534.2,226.1 L535.3,221.7 L537.3,219.4 L542.5,220.8 L542.2,222.8 Z"></path>
      ...
      <div class="col-md-4">
        <select id="myselect" class="form-control form-control-sm">
          <option value="uz_tk" selected="selected"><?php echo app('translator')->getFromJson('blog.svgmap_default_select'); ?></option>
          <option value="uz_an"><?php echo app('translator')->getFromJson('blog.uz_an'); ?></option>
          <option value="uz_na"><?php echo app('translator')->getFromJson('blog.uz_na'); ?></option>
          <option value="uz_fa"><?php echo app('translator')->getFromJson('blog.uz_fa'); ?></option>
          <option value="uz_ta"><?php echo app('translator')->getFromJson('blog.uz_ta'); ?></option>
          <option value="uz_si"><?php echo app('translator')->getFromJson('blog.uz_si'); ?></option>
          <option value="uz_ji"><?php echo app('translator')->getFromJson('blog.uz_ji'); ?></option>
          <option value="uz_sa"><?php echo app('translator')->getFromJson('blog.uz_sa'); ?></option>
          <option value="uz_qa"><?php echo app('translator')->getFromJson('blog.uz_qa'); ?></option>
          <option value="uz_su"><?php echo app('translator')->getFromJson('blog.uz_su'); ?></option>
          <option value="uz_bu"><?php echo app('translator')->getFromJson('blog.uz_bu'); ?></option>
          <option value="uz_nv"><?php echo app('translator')->getFromJson('blog.uz_nv'); ?></option>
          <option value="uz_xo"><?php echo app('translator')->getFromJson('blog.uz_xo'); ?></option>
          <option value="uz_qo"><?php echo app('translator')->getFromJson('blog.uz_qo'); ?></option>
        </select>
        <br />
        <div style="background-color: #fff; padding: 20px;">
          <p><?php echo app('translator')->getFromJson('blog.svgmap_manager'); ?>:</p>
          <h4 id="name"></h4>
          <p><?php echo app('translator')->getFromJson('blog.svgmap_phone'); ?>:</p>
          <h4 id="phone"></h4>
          <p><?php echo app('translator')->getFromJson('blog.svgmap_email'); ?>:</p>
          <h4 id="email"></h4>
        </div>
      </div>
  ...
  <div id="useful-links" class="container-fluid" style="background-color: #1873B7">
    <div class="row"><br />
      <div class="container text-center">
        ...
        <div class="col-sm-4">
          <h3><?php echo app('translator')->getFromJson('blog.links'); ?></h3>
        </div>
        <div class="col-sm-4 hidden-xs">
          <hr />
        </div>
                ...
                <div class="row" style="margin-bottom: 15px">
                    ...
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://press-service.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/4b672ff4319b3af87bb4ccbb4eb13a0a.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Президентининг Матбуот хизмати <a href="http://press-service.uz"><i>http://press-service.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://gov.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/ed491e092adbe6ee3415266ef5fd1f43.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикасининг Ҳукумат портали <a href="http://gov.uz"><i>http://gov.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://parliament.gov.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/ac647d11476a0a672d0b71979511f83c.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Олий Мажлиси Қонунчилик палатаси <a href="http://parliament.gov.uz"><i>http://parliament.gov.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://senat.gov.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/321c9e15d092eefbc937ee31aac4b5e9.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Олий Мажлисининг Сенати <a href="http://senat.gov.uz"><i>http://senat.gov.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://mfa.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('/images/ab0b014bf588d43f5990253d105dead0.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Ташқи ишлар вазирлиги <a href="http://mfa.uz"><i>http://mfa.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://mfer.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/79149419336731cfcf652e5f0de970b5.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Ташқи иқтисодий алоқалар вазирлиги <a href="http://mfer.uz"><i>http://mfer.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://mineconomy.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/777a93ff01da92d3bba4d6336bf17250.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Иқтисодиёт вазирлиги <a href="http://mineconomy.uz"><i>http://mineconomy.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://mf.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/6d8252b7d8812814c780142f39a3a6ef.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://soliq.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/b5af77c13874cc738ec3769065ac6fb9.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Давлат солиқ қўмитаси <a href="http://soliq.uz"><i>http://soliq.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://my.gov.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/21f4a2839aa609b522f317db7f1b4598.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ягона интерактив давлат хизматлари портали <a href="http://my.gov.uz"><i>http://my.gov.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://minjust.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/16755169f85499570f948c472dfa4f8a.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Адлия вазирлиги <a href="http://minjust.uz"><i>http://minjust.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://fvv.uz/" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/314ba204201f5f2f45dd620cdbaba293.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Фавқулодда вазиятлар вазирлиги <a href="http://fvv.uz/"><i>http://fvv.uz/</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="www.gis.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/05d891941204b74cc928bc62d913a534.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://strategy.gov.uz/uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/a2db4b2182c8611e223b953e90944ea2.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>2017-2021 йилларда Ўзбекистон Республикасини ривожлантиришнинг ҳаракатлар стратегияси <a href="http://strategy.gov.uz/uz"><i>http://strategy.gov.uz/uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://customs.uz/" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/9c6c0b3d78653979d70d1adb49f11910.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Давлат божхона қўмитаси <a href="http://customs.uz/"><i>http://customs.uz/</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://stat.uz/" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/ef1d28619337deaa2ccb5d8556ae614f.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Давлат статистика қўмитаси <a href="http://stat.uz/"><i>http://stat.uz/</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uznature.uz/" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/aa7ed273f3c4f3353134c89a20ac5084.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Табиатни муҳофаза қилиш давлат қўмитаси <a href="http://uznature.uz/"><i>http://uznature.uz/</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://davarx.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/8690d5e184d221df37a2d63679b682b5.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Давлат архитектура ва қурилиш қўмитаси <a href="http://davarx.uz"><i>http://davarx.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://www.mehnat.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/1842e6dbc134e5e7ad6b5af28b68605b.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Бандлик ва меҳнат муносабатлари вазирлиги <a href="http://www.mehnat.uz"><i>http://www.mehnat.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://reestr.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/fe6084ee0a2165599633b4e5d9915d8f.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Давлат ахборотга оид манбаъларни ва ахборотга оид тизимларини давлат идоралар Рўйхати <a href="http://reestr.uz"><i>http://reestr.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://sovminrk.gov.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/6029693faa7cd8087951e7a372b3fa34.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Қорақалпоғистон Республикаси Вазирлар Кенгаши <a href="http://sovminrk.gov.uz"><i>http://sovminrk.gov.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://andijan.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/1beab5420fbb29bc7ff7c6d153ad531c.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://buxoro.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/e3a01b421f227a9e726d64f85eeee232.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://jizzax.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/7c546762422513cab8ea379e6d6fb933.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://qashqadaryo.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/753a353e1a57aa54cae56249ecfffc61.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Хокимият Кашкадарьинской области <a href="http://qashqadaryo.uz"><i>http://qashqadaryo.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://navoi.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/6cc73af8ca031caf2d2f2c235bc8f3ef.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://namangan.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/c7c2621e2dece1ce1c10ec8716e3f9c1.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://samarkand.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/c20e51ce18fd89e9f6fd449bdb9e3068.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://soliq.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/904fe494618b894e422db509bcb6df85.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Сурхондарё вилоят ҳокимлиги <a href="http://surxondaryo.uz"><i>http://surxondaryo.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://sirdaryo.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/a53f2720644b643f1040d16db24680ec.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://toshvil.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/522e8bbece9a5fd7724ae950ec0a4cae.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://ferghana.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/857c3216e3d8090167706d8f7f196dc4.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://xorazm.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/7a66b2e342f2d74afa83ce42e022efcc.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://ygk.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/08a4dda8c9fd2e400fcca5b004c1355f.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uzgeolcom.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/c8ddd74d447b8a50772956a00fd52319.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси Давлат геология ва минерал ресурслар қўмитаси <a href="http://uzgeolcom.uz"><i>http://uzgeolcom.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uzdon.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/bbb1e6f5cab0c96eba7ebd8fa02f35de.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://meteo.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/f157b52cb560cc262b660758aebef394.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Гидрометеорология хизмат маркази <a href="http://meteo.uz" target="_blank"><i>http://meteo.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://paxta.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/e850ca90aa73c1d4ef8885ab5c0c7ec3.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>"Ўзпахтасаноат" уюшмаси <a href="http://paxta.uz" target="_blank"><i>http://paxta.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://qishloqqurilishbank.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/7f58414a1576f822e801b76711d36a14.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Кишлок курилиш банк <a href="http://qishloqqurilishbank.uz" target="_blank"><i>http://qishloqqurilishbank.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://chamber.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/fba88b80796eddc35e2143e5d474433f.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон савдо-саноат палатаси <a href="http://chamber.uz" target="_blank"><i>http://chamber.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://agros.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/ef5a8e6a1251f24d630f1c90cf90cf18.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>“Ўзагросуғурта” ДАСК (АЖ) <a href="http://agros.uz" target="_blank"><i>http://agros.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://agrobank.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/eb3711047e92157ecad6fae07cdfa310.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uzex.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/a581d534923dad6169c8ae2211b81120.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республика товар хомашё биржаси <a href="http://uzex.uz" target="_blank"><i>http://uzex.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uza.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/f51ec7f74279bc148a69d8afbc2aab32.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Миллий ахборот агентлиги <a href="http://uza.uz" target="_blank"><i>http://uza.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uz24.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/8246257160f906c43f509075eced6f4f.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Uz24.uz Ўзбекистон матбуот ва ахборот агентлиги <a href="http://uz24.uz" target="_blank"><i>http://uz24.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uForum.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/b8d74c798382b6518f72e1f60af0f00f.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://id.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/9fbbd62ebde9e941341b2bf767a64b91.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>ID.UZ - ягона идентификация тизими <a href="http://id.uz" target="_blank"><i>http://id.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://www.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/36bb68524343b475f74441d05c32647d.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://samqxi.uz/index.php/uz/" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/6c32962fb5d0b26f19c6587ec6b2ab01.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Самарқанд қишлоқ хўжалиги институти <a href="http://samqxi.uz/index.php/uz/" target="_blank"><i>samqxi.uz/index.php/uz/</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://andqxi.uz/uz/" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/8ff7093135951aaf45f36e179413b595.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Андижон қишлоқ хўжалиги институти <a href="http://andqxi.uz/uz/" target="_blank"><i>http://andqxi.uz/uz/</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://tiimbf.uz/" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/40548d7da007511c08ee422c8f4f7ab6.jpg')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Тошкент ирригация ва мелиорация институти Бухоро филиали <a href="http://tiimbf.uz/" target="_blank"><i>http://tiimbf.uz/</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://agrar.uz/nukus-branch" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/8b21530c59c10ce02b3dffd72cacac09.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Тошкент давлат аграр университети Нукус филиали <a href="http://agrar.uz/nukus-branch" target="_blank"><i>http://agrar.uz/nukus-branch</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row" style="margin-bottom: 15px">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://tiim.uz/" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/8d5670675ef6f2ee2726615077ee7657.jpg')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Тошкент ирригация ва мелиорация институти <a href="http://tiim.uz/" target="_blank"><i>http://tiim.uz/</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://agrar.uz/" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/186fe6a17c9a6f13212e4a40ba5e36ec.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Тошкент давлат аграр университети <a href="http://agrar.uz/" target="_blank"><i>http://agrar.uz/</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://academy.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/b2a3bbcb9a4da3d7b5a9d9a430fa91f1.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>Ўзбекистон Республикаси фанлар академияси <a href="http://academy.uz" target="_blank"><i>http://academy.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://natlib.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/2d22a4e1edcc2fac5e028e76c7c2d9a1.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
                          <h6>А. Навоий номидаги Ўзбекистон миллий кутубхонаси <a href="http://natlib.uz" target="_blank"><i>http://natlib.uz</i></a></h6>
                        </div>
                      </div>
                    </div>
                  </div><!-- .col-sm-3 -->
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://ziyonet.uz" target="_blank"><img class="img-circle" src="<?php echo e(URL('images/229ff45be340a1941e0cdddd64bb3ac4.png')); ?>" alt="" width="67" height="67"></a>
                        </div>
                        <div class="media-body">
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="item">
              <b><?php echo app('translator')->getFromJson('blog.ishonch_tel'); ?></b>: <br />(71) 202-47-00<br />
              <br />
              <b><?php echo app('translator')->getFromJson('blog.devonxona_tel'); ?></b>: <br />(71) 237-09-26<br />
              <br />
              <b><?php echo app('translator')->getFromJson('blog.fax'); ?></b>:<br />(71) 237-09-26<br />
              <br />
              <b><?php echo app('translator')->getFromJson('blog.contact_email'); ?></b>:<br />mwr@minwater.uz<br />
              <br />
              <b><?php echo app('translator')->getFromJson('blog.ministry_address'); ?></b>: <?php echo app('translator')->getFromJson('blog.ministry_address_text'); ?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="send-error hidden-xs">
                  <a href="//orphus.ru" id="orphus" target="_blank" title="Система Orphus"><img alt="Система Orphus" src="/images/orphus.gif" border="0" width="240" height="48"></a>
              ...
              <div class="col-md-6">
                <div class="row center-block">
                  <div>
                    ...
                    <p><span class="lastmodify"><?php echo app('translator')->getFromJson('blog.last_update'); ?> <?php echo e(date_format($date, "d.m.Y")); ?> y. |
                        <?php echo e(date_format($date, "H:i")); ?></span></p>
                  </div>
                  <div>
                    <p><?php echo app('translator')->getFromJson('blog.online'); ?>: <?php echo e($numberOfGuests + $numberOfUsers); ?> киши</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container-fluid text-center" style="background-color: #063E78">
      <h6>© 2018 - <script>
        ...
        </script> | <?php echo app('translator')->getFromJson('blog.company_name'); ?></h6>
    </div>
  </footer>
  <?php echo $__env->yieldSection(); ?>
  <script type="text/javascript" src="<?php echo e(URL('js/orphus.js')); ?>"></script>
  <script>
    var app = new Vue({
      el: '#app',
      data: {
...
</html><?php /**PATH D:\OpenServer\domains\gca\resources\views\layout\defualt1.blade.php ENDPATH**/ ?>