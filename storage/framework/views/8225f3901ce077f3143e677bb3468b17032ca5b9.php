  ...
  <div class="special-settings">
    <div class="special-settings-wrapper clearfix container">
      ...
      <div class="norm-version col-md-4">
        <a href="<?php echo e('/'.URL(App::getLocale())); ?>" id="normalversion" data-set="normalversion"
    ...
    <div class="container">
          ...
          <div class="col-sm-8 col-xs-5" id="app">
            ...
            <a href="#" v-if="readCookie('voice') == 'off'" id="voices" class="btn sitemap-link voices"
              title="Овозли матн"><span class="glyphicon glyphicon-volume-off" style="font-size:18px;"></span><span
                class="hidden-xs hidden-sm" style="vertical-align:text-bottom;"> <?php echo app('translator')->getFromJson('blog.voice'); ?></span></a>
            ...
            <a href="<?php echo e(URL(App::getLocale().'/map')); ?>" class="btn sitemap-link"><span class="glyphicon glyphicon-globe"
                style="font-size:16px;"></span><span class="hidden-xs hidden-sm" style="vertical-align:text-bottom;">
          ...
          <div class="col-sm-4 col-xs-7 text-right">
            <div class="lang-menu">
              ...
              <a href="/admin" class="btn auth-link"><span class="glyphicon glyphicon-log-in"></span><span
                  class="hidden-xs hidden-sm"> <?php echo app('translator')->getFromJson('blog.enter'); ?></span></a>
              ...
              <a href="<?php echo e(str_replace("/".App::getLocale(),"/".$language->language_prefix,URL::current())); ?>"
                class="btn lang selected"><span class="hidden-xs"><?php echo e($language->language_name); ?></span><span
                  class="visible-xs"><?php echo e($language->language_prefix); ?></span></a>
              <?php else: ?>
              <a href="<?php echo e(str_replace("/".App::getLocale(),"/".$language->language_prefix,URL::current())); ?>"
                class="btn lang "><span class="hidden-xs"><?php echo e($language->language_name); ?></span><span
                  class="visible-xs"><?php echo e($language->language_prefix); ?></span></a>
              <?php endif; ?>
      ...
      <div class="row hidden-xs">
        <div class="col-sm-3 col-md-2 logo">
          <a href="<?php echo e(URL(App::getLocale().'/')); ?>"><img src="<?php echo e(URL('/images/flag_gerb_uz.png')); ?>" alt=""
              class="img-responsive" width="190"></a>
        </div>
        <div class="col-sm-6 site-name">
          <h2><a href="<?php echo e(URL('/'.App::getLocale())); ?>"
              title="ЎзРес Сув хўжалиги вазирлиги"><?php echo app('translator')->getFromJson('blog.company_name'); ?></a></h2>
        </div>
      </div>
              ...
              <div class="row" style="background-color: #fff">
                ...
                <div id="statCarousel" class="carousel slide" data-ride="carousel">
                  ...
                  <ol class="carousel-indicators">
                    <?php $__currentLoopData = $statisticas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$statistica): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key == 0): ?>
                  ...
                  <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
                      <img class="img-responsive center-block"
                        src="<?php echo e(URL(App::getLocale().'/downloads?type=statistica&id='.$statistica->id)); ?>"
                        alt="<?php echo e($statistica->name); ?>">
                    </div>
                    <?php else: ?>
                    <div class="item">
                      <img class="img-responsive center-block"
            ...
            <div class="col request-to-minister">
              ...
              <div class="col">
                <a href="https://pm.gov.uz/uz#/authorities/1/191/_apply"><img class="img-responsive"
                    src="<?php echo e(URL('/images/vazirga-murojaat-banneri.png')); ?>" alt="" /></a>
              </div>
            </div>
            ...
            <div class="events-widget">
              <div class="col force-margin">
                ...
                <div class="well-sm" style="background-color: white;">
                  ...
                  <div class="row">
                    <div class="col-xs-4" style="padding-top: 10px">
                      <a href="<?php echo e(URL(App::getLocale().'/event/'.$value->event_category_id)); ?>"><img class="center-block"
                          src="<?php echo e(URL(App::getLocale().'/downloads?type=event&id='.$value->group)); ?>" width="77"
                          height="63"></a>
                    </div>
                    <div class="col-xs-8">
              ...
              <div class="well-sm force-margin" style="background-color: white;">
                ...
                <div class="row">
                  <div class="col-xs-4" style="padding-top: 10px">
                    <a href="#"><img class="img-responsive center-block"
                        src="<?php echo e(URL('/images/CandidateManagement.png')); ?>" alt=""></a>
                  </div>
                  <div class="col-xs-8">
                    <a href="#">
                ...
                <div class="row">
                  <div class="col-xs-4" style="padding-top: 5px">
                    <a href="#"><img class="img-responsive center-block" src="<?php echo e(URL('/images/water-intensiv.png')); ?>"
                        alt=""></a></div>
                  <div class="col-xs-8">
                    <a href="#">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://press-service.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/4b672ff4319b3af87bb4ccbb4eb13a0a.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://gov.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/ed491e092adbe6ee3415266ef5fd1f43.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://parliament.gov.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/ac647d11476a0a672d0b71979511f83c.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://senat.gov.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/321c9e15d092eefbc937ee31aac4b5e9.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://mfa.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('/images/ab0b014bf588d43f5990253d105dead0.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://mfer.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/79149419336731cfcf652e5f0de970b5.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://mineconomy.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/777a93ff01da92d3bba4d6336bf17250.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://mf.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/6d8252b7d8812814c780142f39a3a6ef.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://soliq.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/b5af77c13874cc738ec3769065ac6fb9.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://my.gov.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/21f4a2839aa609b522f317db7f1b4598.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://minjust.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/16755169f85499570f948c472dfa4f8a.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://fvv.uz/" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/314ba204201f5f2f45dd620cdbaba293.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="www.gis.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/05d891941204b74cc928bc62d913a534.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://strategy.gov.uz/uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/a2db4b2182c8611e223b953e90944ea2.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://customs.uz/" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/9c6c0b3d78653979d70d1adb49f11910.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://stat.uz/" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/ef1d28619337deaa2ccb5d8556ae614f.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uznature.uz/" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/aa7ed273f3c4f3353134c89a20ac5084.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://davarx.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/8690d5e184d221df37a2d63679b682b5.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://www.mehnat.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/1842e6dbc134e5e7ad6b5af28b68605b.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://reestr.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/fe6084ee0a2165599633b4e5d9915d8f.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://sovminrk.gov.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/6029693faa7cd8087951e7a372b3fa34.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://andijan.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/1beab5420fbb29bc7ff7c6d153ad531c.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://buxoro.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/e3a01b421f227a9e726d64f85eeee232.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://jizzax.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/7c546762422513cab8ea379e6d6fb933.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://qashqadaryo.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/753a353e1a57aa54cae56249ecfffc61.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://navoi.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/6cc73af8ca031caf2d2f2c235bc8f3ef.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://namangan.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/c7c2621e2dece1ce1c10ec8716e3f9c1.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://samarkand.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/c20e51ce18fd89e9f6fd449bdb9e3068.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                  ...
                  <div class="col-sm-3">
                    <div class="well-sm col-sm-12">
                      <div class="media">
                        <div class="media-left">
                          <a href="http://soliq.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/904fe494618b894e422db509bcb6df85.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://sirdaryo.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/a53f2720644b643f1040d16db24680ec.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://toshvil.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/522e8bbece9a5fd7724ae950ec0a4cae.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://ferghana.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/857c3216e3d8090167706d8f7f196dc4.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://xorazm.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/7a66b2e342f2d74afa83ce42e022efcc.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://ygk.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/08a4dda8c9fd2e400fcca5b004c1355f.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uzgeolcom.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/c8ddd74d447b8a50772956a00fd52319.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uzdon.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/bbb1e6f5cab0c96eba7ebd8fa02f35de.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://meteo.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/f157b52cb560cc262b660758aebef394.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://paxta.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/e850ca90aa73c1d4ef8885ab5c0c7ec3.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://qishloqqurilishbank.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/7f58414a1576f822e801b76711d36a14.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://chamber.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/fba88b80796eddc35e2143e5d474433f.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://agros.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/ef5a8e6a1251f24d630f1c90cf90cf18.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://agrobank.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/eb3711047e92157ecad6fae07cdfa310.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uzex.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/a581d534923dad6169c8ae2211b81120.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uza.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/f51ec7f74279bc148a69d8afbc2aab32.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uz24.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/8246257160f906c43f509075eced6f4f.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://uForum.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/b8d74c798382b6518f72e1f60af0f00f.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://id.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/9fbbd62ebde9e941341b2bf767a64b91.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://www.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/36bb68524343b475f74441d05c32647d.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://samqxi.uz/index.php/uz/" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/6c32962fb5d0b26f19c6587ec6b2ab01.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://andqxi.uz/uz/" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/8ff7093135951aaf45f36e179413b595.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://tiimbf.uz/" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/40548d7da007511c08ee422c8f4f7ab6.jpg')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://agrar.uz/nukus-branch" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/8b21530c59c10ce02b3dffd72cacac09.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://tiim.uz/" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/8d5670675ef6f2ee2726615077ee7657.jpg')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://agrar.uz/" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/186fe6a17c9a6f13212e4a40ba5e36ec.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://academy.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/b2a3bbcb9a4da3d7b5a9d9a430fa91f1.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://natlib.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/2d22a4e1edcc2fac5e028e76c7c2d9a1.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="http://ziyonet.uz" target="_blank"><img class="img-circle"
                              src="<?php echo e(URL('images/229ff45be340a1941e0cdddd64bb3ac4.png')); ?>" alt="" width="67"
                              height="67"></a>
                        </div>
                        <div class="media-body">
            ...
            <form class="form-horizontal" action="<?php echo e(URL('/obuna')); ?>" method="post">
              ...
              <div class="form-group col-xs-12">
                <input type="email" class="form-control" id="exampleInputEmail2" name="email"
                  placeholder="<?php echo app('translator')->getFromJson('blog.email_push'); ?>">
              </div>
              <div class="form-group col-xs-12">
                <button type="submit" class="btn btn-primary btn-block"
                  style="padding-top: 10px; padding-bottom: 10px"><?php echo app('translator')->getFromJson('blog.obuna_bulish'); ?></button>
              </div>
            </form>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-xs-3">
            <div class="row text-right">
              <div class="col-xs-12">
                <a href="http://kibera.uz" title="Kibera"><?php echo app('translator')->getFromJson('blog.creator'); ?>: <img
                    src="<?php echo e(URL('images/logo-kibera.png')); ?>" title="kibera.uz" alt="kibera.uz" width="95"
                    height="30"></a><br /><br />
                <span class="counters">
                  <a href="http://my.gov.uz"><img src="<?php echo e(URL('images/mygovuz.jpg')); ?>" width="88" height="31"
                      title="Единый портал интерактивных государственных услуг" alt="My.gov.uz"></a>
                  <a href="/uz/PKM_675/"><img src="<?php echo e(URL('images/pkm.png')); ?>" width="88" height="31"
                  ...
                  <a id="bxid_363847" target="_top" href="http://www.uz/rus/toprating/cmd/stat/id/14779"><img
                      id="bxid_80137" width="88" src="<?php echo e(URL('images/counter.png')); ?>" alt="Топ рейтинг www.uz"></a>
                </span>
              </div>
            </div>
          </div>
