...
<div class="card-body" style="background-color: white">
  <div class="col-md-12">
    ...
    <form class="form" role="form" enctype="multipart/form-data" method="post" action="<?php echo e(URL("/admin/sorovatter/edit")); ?>">
        ...
        foreach ($__currentLoopData as $key => $language) : $__env->incrementLoopIndices();
          ...
          <?php if ($key == 0) : ?>
            ...
            foreach ($__currentLoopData as $val) : $__env->incrementLoopIndices();
              $loop = $__env->getLastLoop(); ?>
              <input type="hidden" name="savol_id" value="<?php echo e($val->savol_id); ?>">
                ...
                <div class="tab-pane active" id="<?php echo e($language->id); ?>">
                  <div class="form" role="form">
                    ...
                    <div class="form-group floating-label">
                      <input type="text" name="javob[]" class="form-control" value="<?php echo e($val->javob); ?>" id="regular2">
...
<?php echo $__env->make("admin.layout.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\admin\sorovatter_edit.blade.php ENDPATH**/ ?>