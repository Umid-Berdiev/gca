        ...
        <div class="container">
            ...
            <div class="row">
                <?php $__env->startSection('nowosti'); ?>
                    <div class="page-content">
                        <div>
                            <ol class="breadcrumb h6">
                                ...
                                <li><a href="<?php echo e(URL(App::getLocale().'/photo/')); ?>" title="<?php echo app('translator')->getFromJson('blog.photo'); ?>"><?php echo app('translator')->getFromJson('blog.photo'); ?></a></li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="page-header row section-to-print">
                        ...
                        <div class="col-md-3 hidden-xs hidden-sm" style="padding-top: 11px;">
                            ...
                            <a class="rss-link pull-right" href="<?php echo e(URL(\Illuminate\Support\Facades\App::getLocale().'/rss/photo')); ?>"><img src="<?php echo e(URL('/images/Feed-icon.svg.png')); ?>" alt="" width="20" height="20"> RSS</a>
                        </div>
                    </div>
                    <br>
                <div class="row" id="print_all">
                    ...
                    <div class="col-md-4">
                        <a href="<?php echo e(URL(App::getLocale()."/photo/".$value->group."/all")); ?>"><img src="<?php echo e(URL(App::getLocale().'/downloads?type=photo&id='.$value->group)); ?>" alt="" class="img-responsive"></a>
                        <h4><a href="<?php echo e(URL(App::getLocale()."/photo/".$value->group."/all")); ?>"><b><?php echo e($value->title); ?></b></a></h4>
                        <h6><?php echo e($value->created_at); ?></h6>
                ...
                <div class="col-md-3" style="padding-top: 50px;">
                    <div class="col menu-item-structure">
                        <div class="col" style="background-color: #3075ff; padding: 5px 15px; color: #fff">
                            <h4><?php echo app('translator')->getFromJson('blog.photo'); ?></h4>
                        </div>
                        <div class="list-group">
                            <?php $__currentLoopData = $newscat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($curcat->group == $value->group): ?>
                                    <a href="<?php echo e(URL(App::getLocale().'/photo/'.$value->group)); ?>" class="list-group-item active"><?php echo e($value->title); ?></a>
                                <?php else: ?>
                                    <a href="<?php echo e(URL(App::getLocale().'/photo/'.$value->group)); ?>" class="list-group-item"><?php echo e($value->title); ?></a>
                                    <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.defualt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\mediaphoto.blade.php ENDPATH**/ ?>