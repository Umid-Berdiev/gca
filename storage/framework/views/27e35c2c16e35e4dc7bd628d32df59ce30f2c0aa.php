...
<div class="card-body" style="background-color: white">
  ...
  <div class="col-md-12">
    ...
    <form class="form" role="form" enctype="multipart/form-data" method="post" action="<?php echo e(route('documents.store')); ?>">
      <?php echo csrf_field(); ?>
      <div class="card-body tab-content">
        ...
        <div class="tab-pane active" id="<?php echo e($language->id); ?>">
          <div class="form" role="form">
            ...
            <div class="form-group floating-label">
              <input type="text" name="other_links[]" class="form-control" id="other_link">
...
<?php echo $__env->make("admin.layout.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views/admin/document/create.blade.php ENDPATH**/ ?>