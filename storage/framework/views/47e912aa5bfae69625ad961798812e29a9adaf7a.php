                ...
                <?php $__env->startSection('nowosti'); ?>
                    ...
                    <div class="page-header row">
                        ...
                        <div class="col-md-3 hidden-xs hidden-sm" style="padding-top: 11px;">
                            ...
                            <a class="rss-link pull-right" href="<?php echo e(URL(\Illuminate\Support\Facades\App::getLocale().'/rss/event')); ?>"><img src="<?php echo e(URL('/images/Feed-icon.svg.png')); ?>" alt="" width="20" height="20"> RSS</a>
                        </div>
                    </div>
                    <br>
                    <?php if($errors->any()): ?>
                    ...
                    <div class="tenders-filter">
                        <form action="<?php echo e(URL(App::getLocale().'/events/filter')); ?>" method="get" name="tenders_archive_filter">
                            ...
                            <table width="100%" class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(URL(App::getLocale().'/event/'.$curcat->group)); ?>"  name="clear"  class="btn btn-warning">Тозалаш</a></td>
                                </tr>
                                </tbody>
                            </table>
                        </form>
                        ...
                        <div class="item page-header">
                            <div class="row">
                                <div class="col-md-3 col-sm-4">
                                    <a href="<?php echo e(URL(App::getLocale().'/event/'.$curcat->group.'/'.$value->group)); ?>"><img class="img-responsive" src="<?php echo e(URL(App::getLocale().'/downloads?type=event&id='.$value->group)); ?>"></a>
                                ...
                                <div class="col-md-9 col-sm-8 section-to-print">
                                    ...
                                    <h4><a href="<?php echo e(URL(App::getLocale().'/event/'.$curcat->group.'/'.$value->group)); ?>"><?php echo e($value->title); ?></a></h4>
                                    <div class="row">
                                        <div class="col-sm-4"><p class="small">Ташкилотчи: <span class="text-primary"><?php echo e($value->organization); ?></span></p></div>
                                    ...
                                    <p style="text-align: justify;"><?php echo e($value->description); ?></p>
                                </div>
                            </div><br><!-- .row -->
                        </div><!-- .item -->
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col menu-item-structure">
                        ...
                        <div class="list-group">
                            <?php $__currentLoopData = $newscat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="<?php echo e(URL(App::getLocale().'/event/'.$value->group)); ?>" class="list-group-item active"><?php echo e($value->category_name); ?></a>
                                <?php else: ?>
...
<?php echo $__env->make('layout.defualt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\event.blade.php ENDPATH**/ ?>