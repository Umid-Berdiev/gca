        ...
        <div class="container">
            <div class="ftr_top_main">
                <div class="ft1">
                    ...
                    <p><?php echo app('translator')->getFromJson('blog.address_placeholder'); ?></p>
                    <div class="abouts">
                        ...
                        <a href="" onclick="return false;">
                            ...
                            <?php echo app('translator')->getFromJson('blog.address'); ?></a>
                    </div>
                </div>
                <div class="ft2">
                    <h5><?php echo app('translator')->getFromJson('blog.map'); ?></h5>
                        ...
                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(count($modelsx) >0): ?>
                                <li >
                                    ...
                                    <?php if($valuex->group == 1603288573): ?>
                                    <a href="<?php echo e(URL(App::getLocale()."/photo/1603197076")); ?>">
                                        <?php echo e($value->menu_name); ?>

                                    </a>
                                    <?php elseif($valuex->group == 1603217598): ?>
                                        <a href="<?php echo e(URL(App::getLocale()."/doc/1546094482")); ?>">
                                            <?php echo e($value->menu_name); ?>
                                                    ...
                                                    <ul class="sub_menu">
                                                        <?php $__currentLoopData = $modelsxs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valuexx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <li><a href="<?php if($valuexx->type =="1"): ?>
                                                                ...
                                                                <?php echo e(URL(App::getLocale()."/doc/"/1603263016)); ?>
                ...
                <div class="ft4">
                    <h5><?php echo app('translator')->getFromJson('blog.additional_message'); ?></h5>
                    <p><?php echo app('translator')->getFromJson('blog.additional_message_placeholder'); ?></p>
...
<?php /**PATH D:\OpenServer\domains\gca\resources\views\gca\blocks\footer.blade.php ENDPATH**/ ?>