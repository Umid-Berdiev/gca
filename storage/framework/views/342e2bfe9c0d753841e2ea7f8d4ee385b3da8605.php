                ...
                <?php $__env->startSection('nowosti'); ?>
                    <div class="page-content">
                        <div>
                            <ol class="breadcrumb h6">
                                ...
                                <li><a href="<?php echo e(URL(App::getLocale().'/doc/'.$curcat->group)); ?>"><?php echo e($curcat->category_name); ?></a></li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="page-header row">
                        ...
                        <div class="col-md-3 hidden-xs hidden-sm" style="padding-top: 11px;">
                            ...
                            <a class="rss-link pull-right" href="<?php echo e(URL(\Illuminate\Support\Facades\App::getLocale().'/rss/doc')); ?>"><img src="<?php echo e(URL('/images/Feed-icon.svg.png')); ?>" alt="" width="20" height="20"> RSS</a>
                        </div>
                    </div>
                    <br>
                    ...
                    <?php $__currentLoopData = $table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="file-box">
                                <span><a href="<?php echo e(URL(App::getLocale().'/doc/'.$value->doc_category_id.'/'.$value->group)); ?>" class=""><?php echo e($value->title); ?></a></span>
                                <span><a href="<?php echo e(URL(App::getLocale().'/doc/'.$value->doc_category_id.'/'.$value->group)); ?>" class="">| <?php echo app('translator')->getFromJson('blog.more'); ?></a></span>

                                <div class="row">
                                    <?php if($value->r_number != null): ?>
                                    <div class="col-md-5"><h6><?php echo app('translator')->getFromJson('blog.register_date'); ?>: <?php echo e($value->r_date); ?> | <?php echo app('translator')->getFromJson('blog.number'); ?>: <?php echo e($value->r_number); ?> </h6></div>
                                    <?php endif; ?>
                                        <div class="col-md-7">
                                        <?php if($value->link  != null): ?>
                                        <div class="col-md-4"><h6><a href="<?php echo e(URL($value->link)); ?>"><img src="<?php echo e(URL('/images/lexuz.png')); ?>" alt="" width="42" height="15"> Lex.uz да ўқиш</a></h6></div>
                                        <?php endif; ?>
                                            <?php if($value->other_link  != null): ?>
                                                <div class="col-md-4"><h6><a href="<?php echo e(URL($value->other_link)); ?>"><img src="<?php echo e(URL('/images/icons8-internet-explorer-15.png')); ?>" alt="" width="15" height="15"> Сайтда ўқиш</a></h6></div>
                                            <?php endif; ?>
                                        <?php if($value->file_type == 'docx' ||  $value->file_type == 'doc'): ?>
                                        <div class="col-md-4"><h6><a href="<?php echo e(URL(App::getLocale().'/downloads?type=doc&id='.$value->id)); ?>"><img src="<?php echo e(URL('/images/msword.jpg')); ?>" alt="" width="15" height="15"> <?php echo app('translator')->getFromJson('blog.download'); ?> (<?php echo e(round($value->file_size/1024)); ?> KB)</a></h6></div>
                                        <?php elseif($value->file_type == 'pdf'): ?>
                                            <div class="col-md-4"><h6><a href="<?php echo e(URL(App::getLocale().'/downloads?type=doc&id='.$value->id)); ?>"><img src="<?php echo e(URL('/images/pdf_image.jpg')); ?>" alt="" width="15" height="15"> <?php echo app('translator')->getFromJson('blog.download'); ?> (<?php echo e(round($value->file_size/1024)); ?> KB)</a></h6></div>
                                        <?php endif; ?>
                ...
                <div class="col-md-3" style="padding-top: 50px;">
                    <div class="col menu-item-structure">
                        <div class="col" style="background-color: #3075ff; padding: 5px 15px; color: #fff">
                            <h4><?php echo app('translator')->getFromJson('blog.docs'); ?></h4>
                        </div>
...
<?php echo $__env->make('layout.defualt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\doc.blade.php ENDPATH**/ ?>