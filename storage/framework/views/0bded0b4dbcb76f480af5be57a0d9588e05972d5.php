            ...
            <div class="row">
                <?php $__env->startSection('nowosti'); ?>
                    ...
                    <div class="page-header row section-to-print">
                        <div class="col-md-9">
                            <h4><b><?php echo app('translator')->getFromJson('blog.photo'); ?></b></h4>
                        </div>
...
<?php echo $__env->make('layout.defualt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\photo.blade.php ENDPATH**/ ?>