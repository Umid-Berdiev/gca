...
<div class="card-body" style="background-color: white">
  <div class="col-md-12">
    ...
    <form class="form" role="form" enctype="multipart/form-data" method="post" action="<?php echo e(URL("/admin/post/edit")); ?>">
              ...
              <div class="form" role="form">
                ...
                foreach ($__currentLoopData as $val) : $__env->incrementLoopIndices();
                  ...
                  <?php if ($val->language_id == $language->id) : ?>
                    ...
                    <div class="form-group floating-label">
                      <input type="datetime-local" name="datetime" value="<?php echo e(\Carbon\Carbon::parse($val->datetime)->format('Y-m-d\TH:i')); ?>" class="form-control" id="regular2">
                    </div>
                    <div class="form-group floating-label">
                    ...
                    <div class="form-group floating-label">
                      <input type="text" name="decription[]" class="form-control" value="<?php echo e($val->decription); ?>" id="regular2">
                      <label for="regular2">Decription</label>
                    </div>

                    <div class="form-group floating-label">
                      <div><img width="100" src="<?php echo e(URL(App::getLocale() . '/downloads?type=post&id=' . $val->group)); ?>">
                      </div>
                      <input type="file" name="cover" class="form-control" value="" id="regular2">
                      <label for="regular2">Cover</label>
                    </div>
                    <div class="form-group floating-label">
                      <select class="form-control" name="country_id" id="country">
                        <?php $__currentLoopData = $gcainfo;
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
                          $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="form-group floating-label">
                      <textarea name="content[]" class="form-control"><?php echo e($val->content); ?></textarea>
