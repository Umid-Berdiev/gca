    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-xs-7 text-right">
            <div class="lang-menu">
              ...
              <a href="<?php echo e(URL('/login')); ?>" class="btn auth-link"><span class="glyphicon glyphicon-log-in"></span><span
      ...
      <div class="row hidden-xs">
        ...
        <div class="col-sm-3 col-md-2 logo2">
          <a href="<?php echo e(URL(App::getLocale().'/')); ?>"><img src="<?php echo e(URL('/images/logo2.png')); ?>" alt="" class="img-responsive"
              width="130"></a>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row"><br />
          ...
          <div class="col-sm-3" style="float: right">
            <div class="col">
              <img class="img-responsive" src="<?php echo e(URL(App::getLocale().'/downloads?type=years&id='.$year->id)); ?>"
                alt="" />
            </div>
            <br />
    ...
    <div class="row"><br />
      ...
      <div class="container">
        <ul class="nav nav-tabs">
          <?php $__currentLoopData = $LinksCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($key == 0): ?>
          <li class="active"><a data-toggle="tab" style="margin-top: -23px;"
              href="#tab<?php echo e($value->id); ?>"><?php echo e($value->title); ?></a></li>
          <?php else: ?>
                  ...
                  <div class="well-sm col-sm-12">
                    <div class="media">
                      <div class="media-left">
                        <a href="<?php echo e($Links[$j]->link); ?>" target="_blank"><img class="img-circle"
                            src="<?php echo e(URL(App::getLocale().'/downloads?type=link&id='.$Links[$j]->id)); ?>" width="67"
                            height="67"></a>
                      </div>
        ...
        methods:{
          ...
          send:function () {
            ...
            $.ajax({
              ...
              data: {_token: CSRF_TOKEN, id:this.radios,lang: <?php echo e(\App\Http\Controllers\SearchController::languages()); ?>},
              dataType: 'JSON',
