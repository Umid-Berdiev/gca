...
<body>
  ...
  <div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form class="form" method="post" action="<?php echo e(URL(\Illuminate\Support\Facades\App::getLocale() . "/errorpage")); ?>">
    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-xs-7 text-right">
            <div class="lang-menu">
              ...
              <a href="<?php echo e(URL('/login')); ?>" class="btn auth-link"><span class="glyphicon glyphicon-log-in"></span><span class="hidden-xs hidden-sm"> <?php echo app('translator')->getFromJson('blog.enter'); ?></span></a>
      ...
      <div class="row hidden-xs">
        ...
        <div class="col-sm-3 col-md-2 logo2">
          <a href="<?php echo e(URL(App::getLocale() . '/')); ?>"><img src="<?php echo e(URL('/images/logo2.png')); ?>" alt="" class="img-responsive" width="130"></a>
        </div>
      </div>
      <div class="row visible-xs">
        <div class="col-xs-4"><a href="/">
            <img src="<?php echo e(URL('/images/flag_gerb_uz.png')); ?>" alt="" class="mob-flag" width="100%"></a>
        </div>
        ...
        <div class="col-xs-4"><a href="/">
            <img src="<?php echo e(URL('/images/logo2.png')); ?>" alt="" class="mob-logo" width="90%"></a>
        </div>
      </div>
    </div><!-- .container -->
  </header>
    ...
    <div class="container-fluid" id="main-content">
      <div class="container">
        ...
        <div class="row"><br />
          <div id="home-content" class="col-sm-9">
            <div class="row">
              ...
              <div class="col-sm-3 hidden-xs sidenav">
                ...
                <div class="container-fluid useful-btns">
                  <a href="<?php echo e(URL(App::getLocale() . '/page/5')); ?>" class="" style="color: #fff">
                    <div class="row" style="display: flex; height: 70px; align-items: center; justify-content: center;">
                ...
                <div class="container-fluid useful-btns">
                  <a href="<?php echo e(URL(App::getLocale() . '/send')); ?>" class="" style="color: #fff">
                    <div class="row" style="display: flex; height: 70px; align-items: center; justify-content: center;">
                ...
                <div class="container-fluid useful-btns">
                  <a href="<?php echo e(URL(App::getLocale() . '/posts/1545808964')); ?>" class="" style="color: #fff">
                    <div class="row" style="display: flex; height: 70px; align-items: center; justify-content: center;">
          ...
          <?php
          $year = \App\Years::where('language_id', '=', \App\Http\Controllers\SearchController::languages())->first();
          ?>
          <div class="col-sm-3" style="float: right">
            <div class="col">
              <img class="img-responsive" src="<?php echo e(URL(App::getLocale() . '/downloads?type=years&id=' . $year->id)); ?>" alt="" />
            </div>
            <br />
            ...
            <div class="survey-widget">
              ...
              <div class="info-block" id="sorovs">
                <div class="col-xs-12 info-header">
                  <h4 class="text-center"><?php echo app('translator')->getFromJson('blog.survey'); ?></h4>
                </div>
                <div class="col-xs-12 force-margin" style="background-color:  white; color: black">
                  ...
                  <div class="text-center">
                    ...
                    <div v-if="table.type=='check'">
                      ...
                      <button class="btn btn-success" @click="send()" type="button"><?php echo app('translator')->getFromJson('blog.vote'); ?></button>
  ...
  <div id="useful-links" class="container-fluid" style="background-color: #1873B7">
    <div class="row"><br />
      ...
      $LinksCategories = \App\LinksCategories::where('language_id', '=', \App\Http\Controllers\SearchController::languages())->get();

      ?>
      <div class="container">
        <ul class="nav nav-tabs">
          <?php $__currentLoopData = $LinksCategories;
          $__env->addLoop($__currentLoopData);
          foreach ($__currentLoopData as $key => $value) : $__env->incrementLoopIndices();
            $loop = $__env->getLastLoop(); ?>
            <?php if ($key == 0) : ?>
              <li class="active"><a data-toggle="tab" style="margin-top: -23px;" href="#tab<?php echo e($value->id); ?>"><?php echo e($value->title); ?></a></li>
            <?php else : ?>
              <li><a data-toggle="tab" href="#tab<?php echo e($value->id); ?>"><?php echo e($value->title); ?></a></li>
            <?php endif; ?>
          <?php endforeach;
          $__env->popLoop();
          $loop = $__env->getLastLoop(); ?>
      ...
      <div class="tab-content container-fluid">
        ...
        foreach ($__currentLoopData as $key => $value) : $__env->incrementLoopIndices();
          $loop = $__env->getLastLoop(); ?>
          <?php
          $Links = \App\Links::where('language_id', '=', \App\Http\Controllers\SearchController::languages())->where('category_group', '=', $value->group)->get();
          ?>

          <div id="tab<?php echo e($value->id); ?>" class="tab-pane fade in <?php if ($key == 0) : ?> active <?php endif; ?>">
            <div id="myCarousel<?php echo e($value->id); ?>" class="carousel slide" data-ride="carousel"><br />

              <div class="carousel-inner">


                <?php for ($i = 1; $i <= round(count($Links) / 8); $i++) : ?> <div class="item   <?php if ($i == 1) : ?> active  <?php endif; ?> container">
                    <?php for ($j = ((8 * $i) - 8); $j < count($Links); $j++) : ?> <div class="col-sm-3">
                        <div class="well-sm col-sm-12">
                          <div class="media">
                            <div class="media-left">
                              <a href="<?php echo e($Links[$j]->link); ?>" target="_blank"><img class="img-circle" src="<?php echo e(URL(App::getLocale() . '/downloads?type=link&id=' . $Links[$j]->id)); ?>" width="67" height="67"></a>
                            </div>
                            <div class="media-body">
                              <h6><?php echo e($Links[$j]->title); ?> <a href="<?php echo e($Links[$j]->link); ?>"><i><?php echo e($Links[$j]->link); ?></i></a>
                              </h6>
                            </div>
                          </div>
                        </div>
                      </div>
                      <?php if ($j + 1 == count($Links) || $j == ((8 * $i) - 1)) : ?>
                        <?php break; ?>
                      <?php endif; ?>
                    <?php endfor; ?>
              ...
              <a class="left carousel-control" href="#myCarousel<?php echo e($value->id); ?>" data-slide="prev" style="width: 10%">
                <span class="glyphicon glyphicon-menu-left" style="color: #fff; top:45%;"></span>
                <span class="sr-only">Previous</span>
              </a>
              <a class="right carousel-control" href="#myCarousel<?php echo e($value->id); ?>" data-slide="next" style="width: 10%">
  ...
  <script>
    var sorovs = new Vue({
      ...
      methods: {
        getelement: function() {
          //this = this;
          $.getJSON("<?php echo e(URL(App::getLocale() . "/getsorov")); ?>", function(datax) {
        ...
        send: function() {
          ...
          $.ajax({
            ...
            url: '<?php echo e(URL("/vote")); ?>',
            type: 'POST',
            /* send the csrf-token and the input to the controller */
            data: {
              _token: CSRF_TOKEN,
              id: this.radios,
              lang: <?php echo e(\App\Http\Controllers\SearchController::languages()); ?>
            },
            dataType: 'JSON',
  ...
  <script>
    $('.page-print-link').on("click", function() {
      $('#print_all').printThis({
        ...
        importStyle: false,
        importCSS: false,
        loadCSS: ["<?php echo e(URL('bootstrap/css/bootstrap.min.css')); ?>", "<?php echo e(URL('css/style.css')); ?>"],
      });
    });
  </script>
...
</html><?php /**PATH D:\OpenServer\domains\gca\resources\views\layout\defualt.blade.php ENDPATH**/ ?>