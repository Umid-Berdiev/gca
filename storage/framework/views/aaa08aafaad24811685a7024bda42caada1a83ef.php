        ...
        <div class="row for_med">
            <?php $__currentLoopData = $table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-sm-3 col-4">
                    <div class="over" data-fancybox=":gallery" data-src="<?php echo e(URL(App::getLocale().'/downloads?type=photoin&id='.$values->id)); ?>">
                        <img src="<?php echo e(URL(App::getLocale().'/downloads?type=photoin&id='.$values->id)); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('gca.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\gca\mediain.blade.php ENDPATH**/ ?>