          ...
          foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
            ...
            <?php if (count($modelsx) > 0) : ?>
              <li class="gui-folder">
                ...
                <!--start submenu -->
                <ul>
                  <?php $__currentLoopData = $modelsx;
                  $__env->addLoop($__currentLoopData);
                  foreach ($__currentLoopData as $valuex) : $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if (count($modelsxs) > 0) : ?>
                      ...
                      <li class="gui-folder">
                        ...
                        <ul>
                          <?php $__currentLoopData = $modelsxs;
                          $__env->addLoop($__currentLoopData);
                          foreach ($__currentLoopData as $valuexx) : $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
          ...
          <div class="card-body tab-content">
            ...
            foreach ($__currentLoopData as $key => $language) : $__env->incrementLoopIndices();
              ...
              <?php if ($key == 0) : ?>
                ...
                <?php $__currentLoopData = $edit;
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $valuesx) : $__env->incrementLoopIndices();
                  $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="form" role="form">
                        ...
                        <div class="form-group floating-label">
                          ...
                          <select class="form-control" name="parent_id">
                            ...
                            <?php $__currentLoopData = $menues;
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $keyone => $value) : $__env->incrementLoopIndices();
                              $loop = $__env->getLastLoop(); ?>
                              <?php $modelsx = DB::table("menumakers")
                                ->where("language_id", "=", \App\Http\Controllers\NewsController::getlangid())
                                ->where("parent_id", "=", $value->group)
                              ...
                              <?php if (count($modelsx) > 0) : ?>
                                ...
                                <ul>
                                  <?php $__currentLoopData = $modelsx;
                                  $__env->addLoop($__currentLoopData);
                                  foreach ($__currentLoopData as $keytwo => $valuex) : $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                                    <?php $modelsxs = DB::table("menumakers")
                                      ->where("language_id", "=", \App\Http\Controllers\NewsController::getlangid())
                                      ->where("parent_id", "=", $valuex->group)
                                    ...
                                    <?php if (count($modelsxs) > 0) : ?>
                                      ...
                                      <?php $__currentLoopData = $modelsxs;
                                      $__env->addLoop($__currentLoopData);
                                      foreach ($__currentLoopData as $keythree => $valuexx) : $__env->incrementLoopIndices();
                                        $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group floating-label">
                          ...
                          <select name="alias_category_id" class="form-control">
                            <optgroup label="Docs">
                              <?php $__currentLoopData = $categories["doc"];
                              $__env->addLoop($__currentLoopData);
                              foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                            ...
                            <optgroup label="Tender">
                              <?php $__currentLoopData = $categories["tender"];
                              $__env->addLoop($__currentLoopData);
                              foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                            ...
                            <optgroup label="Event">
                              <?php $__currentLoopData = $categories["event"];
                              $__env->addLoop($__currentLoopData);
                              foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <?php if ($valuesx->alias_category_id == $value->group) : ?>
                            ...
                            <optgroup label="Post">
                              <?php $__currentLoopData = $categories["post"];
                              $__env->addLoop($__currentLoopData);
                              foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <?php if ($valuesx->alias_category_id == $value->group) : ?>
                            ...
                            <optgroup label="Page">
                              <?php $__currentLoopData = $categories["page"];
                              $__env->addLoop($__currentLoopData);
                              foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                            ...
                            <optgroup label="Photo">
                              <?php $__currentLoopData = $categories["photo"];
                              $__env->addLoop($__currentLoopData);
                              foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <?php if ($valuesx->alias_category_id == $value->group) : ?>
                            ...
                            <optgroup label="Photo">
                              <?php $__currentLoopData = $categories["video"];
                              $__env->addLoop($__currentLoopData);
                              foreach ($__currentLoopData as $value) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <?php if ($valuesx->alias_category_id == $value->group) : ?>
