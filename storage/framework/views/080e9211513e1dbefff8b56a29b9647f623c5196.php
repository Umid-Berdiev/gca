          ...
          <div class="language_top right_border">
            ...
            <div class="body_language" style="z-index: 999999!important;">
              ...
              foreach ($__currentLoopData as $key => $language) : $__env->incrementLoopIndices();
                ...
                <a href="<?php echo e(str_replace("/" . App::getLocale(), "/" . $language->language_prefix, URL::current())); ?>" class="<?php echo e(App::getLocale() ?  $language->language_prefix : 'active'); ?>"><?php echo e($language->language_name); ?></a>
              <?php endforeach;
              $__env->popLoop();
              $loop = $__env->getLastLoop(); ?>
            </div>
