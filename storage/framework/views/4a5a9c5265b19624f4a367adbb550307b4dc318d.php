            ...
            <div class="row section-to-print">
                <?php $__env->startSection('nowosti'); ?>
                    <div class="page-content">
                        <div>
                            <ol class="breadcrumb h6">
                                ...
                                <li><a href="<?php echo e(URL(App::getLocale().'/page/'.$page_categories[0]->page_category_group_id)); ?>" title="<?php echo e($page_categories[0]->category_name); ?>"><?php echo e($page_categories[0]->category_name); ?></a></li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="page-header row">
                        <div class="col-md-9">
                            <h4><b><?php echo e($page_categories[0]->category_name); ?></b></h4>
                        </div>
                        ...
                        <div class="col menu-item-structure">
                            ...
                            <div class="list-group">
                                <?php $__currentLoopData = $page_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(url(App::getLocale().'/page/'.$row->page_category_group_id.'/'.$row->page_group_id)); ?>" class="list-group-item">
...
<?php echo $__env->make('layout.defualt', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\gca\resources\views\pages_cat.blade.php ENDPATH**/ ?>