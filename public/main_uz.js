...
$(document).ready(function () {
  ...
  $(".specialversion").click(function () {
    ...
    {
      document.cookie = "spec=on;expires=" + setTimeForCookies(120) + "; path=/";;
      window.location.reload();

    }
    else
    {
      document.cookie = "spec=off;expires=" + setTimeForCookies(120) + "; path=/";;
      window.location.reload();
    }
    }, 1);
  ...
  $(".voices").click(function () {
    if(readCookie("voice") == 'off')
    {
      document.cookie = "voice=on; expires=" + setTimeForCookies(120) + "; path=/";;
      window.location.reload();
    }
    else
    {
      document.cookie = "voice=off; expires=" + setTimeForCookies(120) + "; path=/";;
      window.location.reload();
